...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 34 9f             	pushl  (%edi,%ebx,4)
  38:	e8 86 03 00 00       	call   3c3 <open>
  3d:	83 c4 10             	add    $0x10,%esp
  40:	89 c6                	mov    %eax,%esi
  42:	85 c0                	test   %eax,%eax
  44:	78 26                	js     6c <main+0x6c>
  ...
  49:	83 c3 01             	add    $0x1,%ebx
    cat(fd);
  4c:	50                   	push   %eax
  4d:	e8 3e 00 00 00       	call   90 <cat>
    close(fd);
  52:	89 34 24             	mov    %esi,(%esp)
  55:	e8 51 03 00 00       	call   3ab <close>
  for(i = 1; i < argc; i++){
  5a:	83 c4 10             	add    $0x10,%esp
  5d:	39 5d e4             	cmp    %ebx,-0x1c(%ebp)
  60:	75 ce                	jne    30 <main+0x30>
  }
  exit(0);
  62:	83 ec 0c             	sub    $0xc,%esp
  65:	6a 00                	push   $0x0
  67:	e8 17 03 00 00       	call   383 <exit>
      exit(-1);
  6c:	83 ec 0c             	sub    $0xc,%esp
  6f:	6a ff                	push   $0xffffffff
  71:	e8 0d 03 00 00       	call   383 <exit>
    cat(0);
  76:	83 ec 0c             	sub    $0xc,%esp
  79:	6a 00                	push   $0x0
  7b:	e8 10 00 00 00       	call   90 <cat>
    exit(-1);
  80:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
...
00000090 <cat>:
{
  ...
  e6:	e8 15 04 00 00       	call   500 <printf>
      exit(-1);
  eb:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  f2:	e8 8c 02 00 00       	call   383 <exit>
    printf(1, "cat: read error\n");
  f7:	50                   	push   %eax
  f8:	50                   	push   %eax
  f9:	68 7a 08 00 00       	push   $0x87a
  fe:	6a 01                	push   $0x1
 100:	e8 fb 03 00 00       	call   500 <printf>
    exit(-1);
 105:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
 10c:	e8 72 02 00 00       	call   383 <exit>
...
strcpy(char *s, const char *t)
{
 ...
 130:	0f b6 0a             	movzbl (%edx),%ecx
 133:	83 c2 01             	add    $0x1,%edx
 136:	83 c0 01             	add    $0x1,%eax
 139:	88 48 ff             	mov    %cl,-0x1(%eax)
 13c:	84 c9                	test   %cl,%cl
 13e:	75 f0                	jne    130 <strcpy+0x10>
    ;
  s++;
  *s=0;
 140:	c6 40 01 00          	movb   $0x0,0x1(%eax)
  return os;
}
 144:	89 d8                	mov    %ebx,%eax
 146:	5b                   	pop    %ebx
 147:	5d                   	pop    %ebp
 148:	c3                   	ret    
...
0000043b <getprocesstimedetails>:
...
free(void *ap)
{
 ...
 6d5:	a1 80 0b 00 00       	mov    0xb80,%eax
{
 ...
 6f6:	73 10                	jae    708 <free+0x38>
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	a3 80 0b 00 00       	mov    %eax,0xb80
}
 727:	5e                   	pop    %esi
 728:	5f                   	pop    %edi
 729:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 76d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 770:	8b 3d 80 0b 00 00    	mov    0xb80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7b9:	8b 3d 80 0b 00 00    	mov    0xb80,%edi
 ...
 7e2:	e8 e9 fe ff ff       	call   6d0 <free>
  return freep;
 7e7:	a1 80 0b 00 00       	mov    0xb80,%eax
 ...
 837:	0b 00 00 
    base.s.size = 0;
 83a:	bf 84 0b 00 00       	mov    $0xb84,%edi
    base.s.ptr = freep = prevp = &base;
 83f:	c7 05 84 0b 00 00 84 	movl   $0xb84,0xb84
 846:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
