  ...
  ba:	31 db                	xor    %ebx,%ebx
{
 ...
 187:	e8 f4 03 00 00       	call   580 <printf>
    exit(-1);
 18c:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
...
strcpy(char *s, const char *t)
{
 ...
 1a7:	53                   	push   %ebx
 1a8:	8b 5d 08             	mov    0x8(%ebp),%ebx
 1ab:	8b 55 0c             	mov    0xc(%ebp),%edx
  char *os;

  os = s;
  while((*s++ = *t++) != 0)
 1ae:	89 d8                	mov    %ebx,%eax
 1b0:	0f b6 0a             	movzbl (%edx),%ecx
 1b3:	83 c2 01             	add    $0x1,%edx
 1b6:	83 c0 01             	add    $0x1,%eax
 1b9:	88 48 ff             	mov    %cl,-0x1(%eax)
 1bc:	84 c9                	test   %cl,%cl
 1be:	75 f0                	jne    1b0 <strcpy+0x10>
    ;
  s++;
  *s=0;
 1c0:	c6 40 01 00          	movb   $0x0,0x1(%eax)
  return os;
}
...
000004bb <getprocesstimedetails>:
