...
strcpy(char *s, const char *t)
{
  ...
  50:	0f b6 0a             	movzbl (%edx),%ecx
  53:	83 c2 01             	add    $0x1,%edx
  56:	83 c0 01             	add    $0x1,%eax
  59:	88 48 ff             	mov    %cl,-0x1(%eax)
  5c:	84 c9                	test   %cl,%cl
  5e:	75 f0                	jne    50 <strcpy+0x10>
    ;
  s++;
  *s=0;
  60:	c6 40 01 00          	movb   $0x0,0x1(%eax)
  return os;
}
...
0000035b <getprocesstimedetails>:
