...
_shellcopy:     file format elf32-i386
...
int main()
{
  ...
  1b:	68 b8 07 00 00       	push   $0x7b8
  20:	e8 ee 02 00 00       	call   313 <open>
  char str[]={'e','c','h','o',' ','t','\n','l','s','\n'};
  write(f,str,100);
  25:	83 c4 0c             	add    $0xc,%esp
  char str[]={'e','c','h','o',' ','t','\n','l','s','\n'};
  28:	c7 45 ee 65 63 68 6f 	movl   $0x6f686365,-0x12(%ebp)
  int f=open("input",O_RDWR|O_CREATE);
  2f:	89 c3                	mov    %eax,%ebx
  char str[]={'e','c','h','o',' ','t','\n','l','s','\n'};
  31:	b8 73 0a 00 00       	mov    $0xa73,%eax
  write(f,str,100);
  36:	6a 64                	push   $0x64
  char str[]={'e','c','h','o',' ','t','\n','l','s','\n'};
  38:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  write(f,str,100);
  3c:	8d 45 ee             	lea    -0x12(%ebp),%eax
  3f:	50                   	push   %eax
  40:	53                   	push   %ebx
  char str[]={'e','c','h','o',' ','t','\n','l','s','\n'};
  41:	c7 45 f2 20 74 0a 6c 	movl   $0x6c0a7420,-0xe(%ebp)
  write(f,str,100);
  48:	e8 a6 02 00 00       	call   2f3 <write>
  close(f);
  4d:	89 1c 24             	mov    %ebx,(%esp)
  50:	e8 a6 02 00 00       	call   2fb <close>
  exit(0);
...
strcpy(char *s, const char *t)
{
  ...
  89:	88 48 ff             	mov    %cl,-0x1(%eax)
  8c:	84 c9                	test   %cl,%cl
  8e:	75 f0                	jne    80 <strcpy+0x10>
    ;
  s++;
  *s=0;
  90:	c6 40 01 00          	movb   $0x0,0x1(%eax)
  return os;
}
  94:	89 d8                	mov    %ebx,%eax
  96:	5b                   	pop    %ebx
  97:	5d                   	pop    %ebp
  98:	c3                   	ret    
...
0000038b <getprocesstimedetails>:
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	eb 1a                	jmp    5f0 <printf+0x1a0>
          s = "(null)";
 5d6:	bb be 07 00 00       	mov    $0x7be,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 625:	a1 74 0a 00 00       	mov    0xa74,%eax
{
 ...
 646:	73 10                	jae    658 <free+0x38>
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	a3 74 0a 00 00       	mov    %eax,0xa74
}
 677:	5e                   	pop    %esi
 678:	5f                   	pop    %edi
 679:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6bd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6c0:	8b 3d 74 0a 00 00    	mov    0xa74,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 709:	8b 3d 74 0a 00 00    	mov    0xa74,%edi
 ...
 732:	e8 e9 fe ff ff       	call   620 <free>
  return freep;
 737:	a1 74 0a 00 00       	mov    0xa74,%eax
 ...
 764:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 767:	a3 74 0a 00 00       	mov    %eax,0xa74
}
 ...
 787:	0a 00 00 
    base.s.size = 0;
 78a:	bf 78 0a 00 00       	mov    $0xa78,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 78 0a 00 00 78 	movl   $0xa78,0xa78
 796:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 799:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 79b:	c7 05 7c 0a 00 00 00 	movl   $0x0,0xa7c
 7a2:	00 00 00 
    if(p->s.size >= nunits){
