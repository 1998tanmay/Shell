  ...
  1f:	31 db                	xor    %ebx,%ebx
{
  ...
  69:	0f 8f c9 00 00 00    	jg     138 <main+0x138>
  for(i = 0; i < 4; i++)
...
//    printf(fd, "%d\n", i);
 ...
 13a:	e9 3d ff ff ff       	jmp    7c <main+0x7c>
 13f:	90                   	nop
...
strcpy(char *s, const char *t)
{
 ...
 150:	0f b6 0a             	movzbl (%edx),%ecx
 153:	83 c2 01             	add    $0x1,%edx
 156:	83 c0 01             	add    $0x1,%eax
 159:	88 48 ff             	mov    %cl,-0x1(%eax)
 15c:	84 c9                	test   %cl,%cl
 15e:	75 f0                	jne    150 <strcpy+0x10>
    ;
  s++;
  *s=0;
 160:	c6 40 01 00          	movb   $0x0,0x1(%eax)
  return os;
}
...
0000045b <getprocesstimedetails>:
