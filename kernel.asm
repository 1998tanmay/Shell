...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 d7 7f 10 80 	movl   $0x80107fd7,(%esp)
...
80100b0a:	75 ce                	jne    80100ada <exec+0x5a>
  if((pgdir = setupkvm()) == 0)
80100b0c:	e8 df 67 00 00       	call   801072f0 <setupkvm>
...
80100b73:	e8 98 65 00 00       	call   80107110 <allocuvm>
...
80100ba9:	e8 92 64 00 00       	call   80107040 <loaduvm>
...
80100beb:	e8 80 66 00 00       	call   80107270 <freevm>
  if(ip){
...
80100c32:	e8 d9 64 00 00       	call   80107110 <allocuvm>
...
80100c51:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c53:	e8 38 67 00 00       	call   80107390 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100ce1:	e8 8a 65 00 00       	call   80107270 <freevm>
...
80100d2d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d33:	e8 b8 67 00 00       	call   801074f0 <copyout>
...
80100d9d:	e8 0e 61 00 00       	call   80106eb0 <switchuvm>
  freevm(oldpgdir);
80100da2:	89 3c 24             	mov    %edi,(%esp)
80100da5:	e8 c6 64 00 00       	call   80107270 <freevm>
  return 0;
...
80102319:	e8 62 1c 00 00       	call   80103f80 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102486:	81 fb a8 78 11 80    	cmp    $0x801178a8,%ebx
...
80102d5d:	e8 1e 12 00 00       	call   80103f80 <sleep>
...
80103027:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
8010302a:	e8 61 3e 00 00       	call   80106e90 <switchkvm>
  seginit();
8010302f:	e8 cc 3d 00 00       	call   80106e00 <seginit>
  lapicinit();
...
8010305b:	68 a8 78 11 80       	push   $0x801178a8
80103060:	e8 fb f4 ff ff       	call   80102560 <kinit1>
  kvmalloc();      // kernel page table
80103065:	e8 06 43 00 00       	call   80107370 <kvmalloc>
  mpinit();        // detect other processors
8010306a:	e8 81 01 00 00       	call   801031f0 <mpinit>
  lapicinit();     // interrupt controller
8010306f:	e8 2c f7 ff ff       	call   801027a0 <lapicinit>
  seginit();       // segment descriptors
80103074:	e8 87 3d 00 00       	call   80106e00 <seginit>
  picinit();       // disable pic
...
80103088:	e8 33 30 00 00       	call   801060c0 <uartinit>
  pinit();         // process table
...
80103611:	e8 6a 09 00 00       	call   80103f80 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
801036ed:	e8 8e 08 00 00       	call   80103f80 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
801037af:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801037b0:	81 c3 cc 00 00 00    	add    $0xcc,%ebx
801037b6:	81 fb 54 70 11 80    	cmp    $0x80117054,%ebx
...
801037e3:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  release(&ptable.lock);
801037e9:	e8 32 11 00 00       	call   80104920 <release>
...
8010380b:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010380e:	c7 40 14 ff 5c 10 80 	movl   $0x80105cff,0x14(%eax)
  p->context = (struct context*)sp;
...
8010381d:	e8 4e 11 00 00       	call   80104970 <memset>
  cmostime(&(p->create));        //decs
80103822:	8d 83 84 00 00 00    	lea    0x84(%ebx),%eax
80103828:	89 04 24             	mov    %eax,(%esp)
8010382b:	e8 60 f1 ff ff       	call   80102990 <cmostime>
  cmostime(&(p->ct_out));           //decs
80103830:	8d 83 b4 00 00 00    	lea    0xb4(%ebx),%eax
80103836:	89 04 24             	mov    %eax,(%esp)
80103839:	e8 52 f1 ff ff       	call   80102990 <cmostime>
...
80103862:	e8 b9 10 00 00       	call   80104920 <release>
}
...
8010389f:	e8 7c 10 00 00       	call   80104920 <release>
...
801038ea:	68 c0 7a 10 80       	push   $0x80107ac0
801038ef:	68 20 3d 11 80       	push   $0x80113d20
801038f4:	e8 e7 0d 00 00       	call   801046e0 <initlock>
}
...
80103998:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010399b:	e8 c0 0d 00 00       	call   80104760 <pushcli>
  c = mycpu();
801039a0:	e8 5b ff ff ff       	call   80103900 <mycpu>
  p = c->proc;
801039a5:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039ab:	e8 00 0e 00 00       	call   801047b0 <popcli>
}
...
801039d7:	e8 14 39 00 00       	call   801072f0 <setupkvm>
...
801039f5:	e8 c6 35 00 00       	call   80106fc0 <inituvm>
...
80103a0a:	e8 61 0f 00 00       	call   80104970 <memset>
...
80103a63:	68 f0 7a 10 80       	push   $0x80107af0
80103a68:	50                   	push   %eax
80103a69:	e8 c2 10 00 00       	call   80104b30 <safestrcpy>
  p->cwd = namei("/");
80103a6e:	c7 04 24 f9 7a 10 80 	movl   $0x80107af9,(%esp)
80103a75:	e8 b6 e5 ff ff       	call   80102030 <namei>
80103a7a:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103a7d:	c7 04 24 20 3d 11 80 	movl   $0x80113d20,(%esp)
80103a84:	e8 d7 0d 00 00       	call   80104860 <acquire>
  p->state = RUNNABLE;
80103a89:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103a90:	c7 04 24 20 3d 11 80 	movl   $0x80113d20,(%esp)
80103a97:	e8 84 0e 00 00       	call   80104920 <release>
}
...
80103aa7:	68 d7 7a 10 80       	push   $0x80107ad7
...
80103ac9:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103acc:	e8 8f 0c 00 00       	call   80104760 <pushcli>
  c = mycpu();
80103ad1:	e8 2a fe ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103ad6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103adc:	e8 cf 0c 00 00       	call   801047b0 <popcli>
  sz = curproc->sz;
...
80103aef:	e8 bc 33 00 00       	call   80106eb0 <switchuvm>
  return 0;
...
80103b0a:	e8 01 36 00 00       	call   80107110 <allocuvm>
...
80103b2a:	e8 11 37 00 00       	call   80107240 <deallocuvm>
...
80103b4a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b4d:	e8 0e 0c 00 00       	call   80104760 <pushcli>
  c = mycpu();
80103b52:	e8 a9 fd ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103b57:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b5d:	e8 4e 0c 00 00       	call   801047b0 <popcli>
  if((np = allocproc()) == 0){
...
80103b7c:	e8 3f 38 00 00       	call   801073c0 <copyuvm>
...
80103bf9:	e8 32 0f 00 00       	call   80104b30 <safestrcpy>
  pid = np->pid;
80103bfe:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103c01:	c7 04 24 20 3d 11 80 	movl   $0x80113d20,(%esp)
80103c08:	e8 53 0c 00 00       	call   80104860 <acquire>
  np->state = RUNNABLE;
80103c0d:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103c14:	c7 04 24 20 3d 11 80 	movl   $0x80113d20,(%esp)
80103c1b:	e8 00 0d 00 00       	call   80104920 <release>
  return pid;
...
80103c89:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c8c:	bb 54 3d 11 80       	mov    $0x80113d54,%ebx
    acquire(&ptable.lock);
80103c91:	68 20 3d 11 80       	push   $0x80113d20
80103c96:	e8 c5 0b 00 00       	call   80104860 <acquire>
...
80103cb0:	e8 fb 31 00 00       	call   80106eb0 <switchuvm>
      cmostime(&(p->ct_in));             //decs
80103cb5:	8d 83 9c 00 00 00    	lea    0x9c(%ebx),%eax
80103cbb:	89 04 24             	mov    %eax,(%esp)
80103cbe:	e8 cd ec ff ff       	call   80102990 <cmostime>
      swtch(&(c->scheduler), p->context);
80103cc3:	58                   	pop    %eax
80103cc4:	5a                   	pop    %edx
80103cc5:	ff 73 1c             	pushl  0x1c(%ebx)
80103cc8:	57                   	push   %edi
      p->state = RUNNING;
80103cc9:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103cd0:	e8 be 0e 00 00       	call   80104b93 <swtch>
      switchkvm();
80103cd5:	e8 b6 31 00 00       	call   80106e90 <switchkvm>
      c->proc = 0;
80103cda:	83 c4 10             	add    $0x10,%esp
80103cdd:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103ce4:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ce7:	81 c3 cc 00 00 00    	add    $0xcc,%ebx
80103ced:	81 fb 54 70 11 80    	cmp    $0x80117054,%ebx
80103cf3:	75 ab                	jne    80103ca0 <scheduler+0x40>
    release(&ptable.lock);
80103cf5:	83 ec 0c             	sub    $0xc,%esp
80103cf8:	68 20 3d 11 80       	push   $0x80113d20
80103cfd:	e8 1e 0c 00 00       	call   80104920 <release>
    sti();
80103d02:	83 c4 10             	add    $0x10,%esp
80103d05:	eb 81                	jmp    80103c88 <scheduler+0x28>
...
80103d18:	53                   	push   %ebx
  pushcli();
80103d19:	e8 42 0a 00 00       	call   80104760 <pushcli>
  c = mycpu();
80103d1e:	e8 dd fb ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103d23:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d29:	e8 82 0a 00 00       	call   801047b0 <popcli>
  if(!holding(&ptable.lock))
80103d2e:	83 ec 0c             	sub    $0xc,%esp
80103d31:	68 20 3d 11 80       	push   $0x80113d20
80103d36:	e8 d5 0a 00 00       	call   80104810 <holding>
80103d3b:	83 c4 10             	add    $0x10,%esp
80103d3e:	85 c0                	test   %eax,%eax
80103d40:	74 5d                	je     80103d9f <sched+0x8f>
  if(mycpu()->ncli != 1)
80103d42:	e8 b9 fb ff ff       	call   80103900 <mycpu>
80103d47:	83 b8 a4 00 00 00 01 	cmpl   $0x1,0xa4(%eax)
80103d4e:	75 76                	jne    80103dc6 <sched+0xb6>
  if(p->state == RUNNING)
80103d50:	83 7b 0c 04          	cmpl   $0x4,0xc(%ebx)
80103d54:	74 63                	je     80103db9 <sched+0xa9>
  asm volatile("pushfl; popl %0" : "=r" (eflags));
80103d56:	9c                   	pushf  
80103d57:	58                   	pop    %eax
  if(readeflags()&FL_IF)
80103d58:	f6 c4 02             	test   $0x2,%ah
80103d5b:	75 4f                	jne    80103dac <sched+0x9c>
  cmostime(&(p->ct_out));            //decs
80103d5d:	83 ec 0c             	sub    $0xc,%esp
80103d60:	8d 83 b4 00 00 00    	lea    0xb4(%ebx),%eax
  swtch(&p->context, mycpu()->scheduler);
80103d66:	83 c3 1c             	add    $0x1c,%ebx
  cmostime(&(p->ct_out));            //decs
80103d69:	50                   	push   %eax
80103d6a:	e8 21 ec ff ff       	call   80102990 <cmostime>
  intena = mycpu()->intena;
80103d6f:	e8 8c fb ff ff       	call   80103900 <mycpu>
80103d74:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103d7a:	e8 81 fb ff ff       	call   80103900 <mycpu>
80103d7f:	5a                   	pop    %edx
80103d80:	59                   	pop    %ecx
80103d81:	ff 70 04             	pushl  0x4(%eax)
80103d84:	53                   	push   %ebx
80103d85:	e8 09 0e 00 00       	call   80104b93 <swtch>
  mycpu()->intena = intena;
80103d8a:	e8 71 fb ff ff       	call   80103900 <mycpu>
}
80103d8f:	83 c4 10             	add    $0x10,%esp
  mycpu()->intena = intena;
80103d92:	89 b0 a8 00 00 00    	mov    %esi,0xa8(%eax)
}
80103d98:	8d 65 f8             	lea    -0x8(%ebp),%esp
80103d9b:	5b                   	pop    %ebx
80103d9c:	5e                   	pop    %esi
80103d9d:	5d                   	pop    %ebp
80103d9e:	c3                   	ret    
...
80103dea:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103ded:	e8 6e 09 00 00       	call   80104760 <pushcli>
  c = mycpu();
80103df2:	e8 09 fb ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103df7:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103dfd:	e8 ae 09 00 00       	call   801047b0 <popcli>
  if(curproc == initproc)
80103e02:	8d 73 28             	lea    0x28(%ebx),%esi
80103e05:	8d 7b 68             	lea    0x68(%ebx),%edi
80103e08:	39 1d b8 b5 10 80    	cmp    %ebx,0x8010b5b8
80103e0e:	0f 84 03 01 00 00    	je     80103f17 <exit+0x137>
...
80103e3f:	ff 73 68             	pushl  0x68(%ebx)
...
80103e4c:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103e53:	c7 04 24 20 3d 11 80 	movl   $0x80113d20,(%esp)
80103e5a:	e8 01 0a 00 00       	call   80104860 <acquire>
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e65:	b8 54 3d 11 80       	mov    $0x80113d54,%eax
80103e6a:	eb 10                	jmp    80103e7c <exit+0x9c>
80103e6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103e70:	05 cc 00 00 00       	add    $0xcc,%eax
80103e75:	3d 54 70 11 80       	cmp    $0x80117054,%eax
...
80103e87:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e8e:	05 cc 00 00 00       	add    $0xcc,%eax
80103e93:	3d 54 70 11 80       	cmp    $0x80117054,%eax
80103e98:	75 e2                	jne    80103e7c <exit+0x9c>
      p->parent = initproc;
80103e9a:	8b 0d b8 b5 10 80    	mov    0x8010b5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ea0:	ba 54 3d 11 80       	mov    $0x80113d54,%edx
80103ea5:	eb 17                	jmp    80103ebe <exit+0xde>
80103ea7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103eae:	66 90                	xchg   %ax,%ax
80103eb0:	81 c2 cc 00 00 00    	add    $0xcc,%edx
80103eb6:	81 fa 54 70 11 80    	cmp    $0x80117054,%edx
...
80103eca:	75 e4                	jne    80103eb0 <exit+0xd0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ecc:	b8 54 3d 11 80       	mov    $0x80113d54,%eax
80103ed1:	eb 11                	jmp    80103ee4 <exit+0x104>
80103ed3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103ed7:	90                   	nop
80103ed8:	05 cc 00 00 00       	add    $0xcc,%eax
80103edd:	3d 54 70 11 80       	cmp    $0x80117054,%eax
...
80103efb:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  curproc->e_status=status;
80103f02:	89 43 7c             	mov    %eax,0x7c(%ebx)
  sched();
80103f05:	e8 06 fe ff ff       	call   80103d10 <sched>
  panic("zombie exit");
80103f0a:	83 ec 0c             	sub    $0xc,%esp
80103f0d:	68 48 7b 10 80       	push   $0x80107b48
80103f12:	e8 79 c4 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103f17:	83 ec 0c             	sub    $0xc,%esp
80103f1a:	68 3b 7b 10 80       	push   $0x80107b3b
...
80103f3b:	68 20 3d 11 80       	push   $0x80113d20
80103f40:	e8 1b 09 00 00       	call   80104860 <acquire>
  pushcli();
80103f45:	e8 16 08 00 00       	call   80104760 <pushcli>
  c = mycpu();
80103f4a:	e8 b1 f9 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103f4f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f55:	e8 56 08 00 00       	call   801047b0 <popcli>
  myproc()->state = RUNNABLE;
80103f5a:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103f61:	e8 aa fd ff ff       	call   80103d10 <sched>
  release(&ptable.lock);
80103f66:	c7 04 24 20 3d 11 80 	movl   $0x80113d20,(%esp)
80103f6d:	e8 ae 09 00 00       	call   80104920 <release>
}
...
80103f90:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103f93:	e8 c8 07 00 00       	call   80104760 <pushcli>
  c = mycpu();
80103f98:	e8 63 f9 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103f9d:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103fa3:	e8 08 08 00 00       	call   801047b0 <popcli>
  if(p == 0)
...
80103fb4:	81 fe 20 3d 11 80    	cmp    $0x80113d20,%esi
80103fba:	74 4c                	je     80104008 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103fbc:	83 ec 0c             	sub    $0xc,%esp
80103fbf:	68 20 3d 11 80       	push   $0x80113d20
80103fc4:	e8 97 08 00 00       	call   80104860 <acquire>
    release(lk);
80103fc9:	89 34 24             	mov    %esi,(%esp)
80103fcc:	e8 4f 09 00 00       	call   80104920 <release>
  p->chan = chan;
80103fd1:	89 7b 20             	mov    %edi,0x20(%ebx)
  p->state = SLEEPING;
80103fd4:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103fdb:	e8 30 fd ff ff       	call   80103d10 <sched>
  p->chan = 0;
80103fe0:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103fe7:	c7 04 24 20 3d 11 80 	movl   $0x80113d20,(%esp)
80103fee:	e8 2d 09 00 00       	call   80104920 <release>
    acquire(lk);
...
80103fff:	5d                   	pop    %ebp
    acquire(lk);
80104000:	e9 5b 08 00 00       	jmp    80104860 <acquire>
...
80104029:	68 5a 7b 10 80       	push   $0x80107b5a
8010402e:	e8 5d c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80104033:	83 ec 0c             	sub    $0xc,%esp
80104036:	68 54 7b 10 80       	push   $0x80107b54
...
80104048:	53                   	push   %ebx
  pushcli();
80104049:	e8 12 07 00 00       	call   80104760 <pushcli>
  c = mycpu();
8010404e:	e8 ad f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104053:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104059:	e8 52 07 00 00       	call   801047b0 <popcli>
  acquire(&ptable.lock);
8010405e:	83 ec 0c             	sub    $0xc,%esp
80104061:	68 20 3d 11 80       	push   $0x80113d20
80104066:	e8 f5 07 00 00       	call   80104860 <acquire>
8010406b:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
8010406e:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104070:	bb 54 3d 11 80       	mov    $0x80113d54,%ebx
80104075:	eb 17                	jmp    8010408e <wait+0x4e>
80104077:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010407e:	66 90                	xchg   %ax,%ax
80104080:	81 c3 cc 00 00 00    	add    $0xcc,%ebx
80104086:	81 fb 54 70 11 80    	cmp    $0x80117054,%ebx
8010408c:	74 1e                	je     801040ac <wait+0x6c>
      if(p->parent != curproc)
8010408e:	39 73 14             	cmp    %esi,0x14(%ebx)
80104091:	75 ed                	jne    80104080 <wait+0x40>
      if(p->state == ZOMBIE){
80104093:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80104097:	74 37                	je     801040d0 <wait+0x90>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104099:	81 c3 cc 00 00 00    	add    $0xcc,%ebx
      havekids = 1;
8010409f:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040a4:	81 fb 54 70 11 80    	cmp    $0x80117054,%ebx
801040aa:	75 e2                	jne    8010408e <wait+0x4e>
    if(!havekids || curproc->killed){
801040ac:	85 c0                	test   %eax,%eax
801040ae:	0f 84 81 00 00 00    	je     80104135 <wait+0xf5>
801040b4:	8b 46 24             	mov    0x24(%esi),%eax
801040b7:	85 c0                	test   %eax,%eax
801040b9:	75 7a                	jne    80104135 <wait+0xf5>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
801040bb:	83 ec 08             	sub    $0x8,%esp
801040be:	68 20 3d 11 80       	push   $0x80113d20
801040c3:	56                   	push   %esi
801040c4:	e8 b7 fe ff ff       	call   80103f80 <sleep>
    havekids = 0;
801040c9:	83 c4 10             	add    $0x10,%esp
801040cc:	eb a0                	jmp    8010406e <wait+0x2e>
801040ce:	66 90                	xchg   %ax,%ax
        *status= (p->e_status);     
801040d0:	8b 45 08             	mov    0x8(%ebp),%eax
801040d3:	8b 53 7c             	mov    0x7c(%ebx),%edx
        kfree(p->kstack);
801040d6:	83 ec 0c             	sub    $0xc,%esp
        *status= (p->e_status);     
801040d9:	89 10                	mov    %edx,(%eax)
        pid = p->pid;
801040db:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
801040de:	ff 73 08             	pushl  0x8(%ebx)
801040e1:	e8 8a e3 ff ff       	call   80102470 <kfree>
        freevm(p->pgdir);
801040e6:	5a                   	pop    %edx
...
801040ea:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801040f1:	e8 7a 31 00 00       	call   80107270 <freevm>
        release(&ptable.lock);
801040f6:	c7 04 24 20 3d 11 80 	movl   $0x80113d20,(%esp)
        p->e_status=0;
801040fd:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
        p->pid = 0;
...
8010411d:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80104124:	e8 f7 07 00 00       	call   80104920 <release>
        return pid;
...
80104142:	e8 d9 07 00 00       	call   80104920 <release>
      return -1;
80104147:	83 c4 10             	add    $0x10,%esp
8010414a:	eb e0                	jmp    8010412c <wait+0xec>
...
8010415b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010415e:	68 20 3d 11 80       	push   $0x80113d20
80104163:	e8 f8 06 00 00       	call   80104860 <acquire>
80104168:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010416b:	b8 54 3d 11 80       	mov    $0x80113d54,%eax
80104170:	eb 12                	jmp    80104184 <wakeup+0x34>
80104172:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104178:	05 cc 00 00 00       	add    $0xcc,%eax
8010417d:	3d 54 70 11 80       	cmp    $0x80117054,%eax
...
8010418f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104196:	05 cc 00 00 00       	add    $0xcc,%eax
8010419b:	3d 54 70 11 80       	cmp    $0x80117054,%eax
801041a0:	75 e2                	jne    80104184 <wakeup+0x34>
  wakeup1(chan);
  release(&ptable.lock);
801041a2:	c7 45 08 20 3d 11 80 	movl   $0x80113d20,0x8(%ebp)
}
801041a9:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801041ac:	c9                   	leave  
  release(&ptable.lock);
801041ad:	e9 6e 07 00 00       	jmp    80104920 <release>
...
801041cb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
801041ce:	68 20 3d 11 80       	push   $0x80113d20
801041d3:	e8 88 06 00 00       	call   80104860 <acquire>
801041d8:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041db:	b8 54 3d 11 80       	mov    $0x80113d54,%eax
801041e0:	eb 12                	jmp    801041f4 <kill+0x34>
801041e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801041e8:	05 cc 00 00 00       	add    $0xcc,%eax
801041ed:	3d 54 70 11 80       	cmp    $0x80117054,%eax
...
80104210:	68 20 3d 11 80       	push   $0x80113d20
80104215:	e8 06 07 00 00       	call   80104920 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104230:	e8 eb 06 00 00       	call   80104920 <release>
}
...
8010425d:	bb c0 3d 11 80       	mov    $0x80113dc0,%ebx
...
80104273:	68 d7 7f 10 80       	push   $0x80107fd7
80104278:	e8 33 c4 ff ff       	call   801006b0 <cprintf>
8010427d:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104280:	81 c3 cc 00 00 00    	add    $0xcc,%ebx
80104286:	81 fb c0 70 11 80    	cmp    $0x801170c0,%ebx
...
80104297:	74 e7                	je     80104280 <procdump+0x30>
      state = "???";
80104299:	ba 6b 7b 10 80       	mov    $0x80107b6b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010429e:	83 f8 05             	cmp    $0x5,%eax
801042a1:	77 11                	ja     801042b4 <procdump+0x64>
801042a3:	8b 14 85 94 7c 10 80 	mov    -0x7fef836c(,%eax,4),%edx
      state = "???";
801042aa:	b8 6b 7b 10 80       	mov    $0x80107b6b,%eax
...
801042b9:	68 6f 7b 10 80       	push   $0x80107b6f
...
801042e0:	e8 1b 04 00 00       	call   80104700 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
80104301:	68 c1 75 10 80       	push   $0x801075c1
...
80104330 <psinfo>:
//prints all process and their status
//decs 
int                                  
psinfo(void)                                                                             //decs
{
...
80104338:	bb c0 3d 11 80       	mov    $0x80113dc0,%ebx
8010433d:	83 ec 04             	sub    $0x4,%esp
80104340:	eb 3d                	jmp    8010437f <psinfo+0x4f>
...
80104348:	83 f8 01             	cmp    $0x1,%eax
8010434b:	74 6a                	je     801043b7 <psinfo+0x87>
  	if(p->state== SLEEPING)cprintf("SLEEPING\n");
8010434d:	83 f8 02             	cmp    $0x2,%eax
80104350:	74 7d                	je     801043cf <psinfo+0x9f>
  	if(p->state== RUNNABLE)cprintf("RUNNABLE\n");
80104352:	83 f8 03             	cmp    $0x3,%eax
80104355:	0f 84 90 00 00 00    	je     801043eb <psinfo+0xbb>
  	if(p->state== RUNNING)cprintf("RUNNING\n");
8010435b:	83 f8 04             	cmp    $0x4,%eax
8010435e:	0f 84 a3 00 00 00    	je     80104407 <psinfo+0xd7>
  	if(p->state== ZOMBIE)cprintf("ZOMBIE\n");
80104364:	83 f8 05             	cmp    $0x5,%eax
80104367:	0f 84 b6 00 00 00    	je     80104423 <psinfo+0xf3>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010436d:	81 c3 cc 00 00 00    	add    $0xcc,%ebx
80104373:	81 fb c0 70 11 80    	cmp    $0x801170c0,%ebx
80104379:	0f 84 c6 00 00 00    	je     80104445 <psinfo+0x115>
  	if(p->pid==0)continue;
8010437f:	8b 43 a4             	mov    -0x5c(%ebx),%eax
80104382:	85 c0                	test   %eax,%eax
80104384:	74 e7                	je     8010436d <psinfo+0x3d>
  	cprintf("%s %d ",p->name,p->pid);
80104386:	83 ec 04             	sub    $0x4,%esp
80104389:	50                   	push   %eax
8010438a:	53                   	push   %ebx
8010438b:	68 78 7b 10 80       	push   $0x80107b78
80104390:	e8 1b c3 ff ff       	call   801006b0 <cprintf>
  	if(p->state== UNUSED)cprintf("UNUSED\n");                                     
80104395:	8b 43 a0             	mov    -0x60(%ebx),%eax
80104398:	83 c4 10             	add    $0x10,%esp
8010439b:	85 c0                	test   %eax,%eax
8010439d:	75 a9                	jne    80104348 <psinfo+0x18>
8010439f:	83 ec 0c             	sub    $0xc,%esp
801043a2:	68 7f 7b 10 80       	push   $0x80107b7f
801043a7:	e8 04 c3 ff ff       	call   801006b0 <cprintf>
801043ac:	8b 43 a0             	mov    -0x60(%ebx),%eax
801043af:	83 c4 10             	add    $0x10,%esp
  	if(p->state== EMBRYO)cprintf("EMBRYO\n");
801043b2:	83 f8 01             	cmp    $0x1,%eax
801043b5:	75 96                	jne    8010434d <psinfo+0x1d>
801043b7:	83 ec 0c             	sub    $0xc,%esp
801043ba:	68 87 7b 10 80       	push   $0x80107b87
801043bf:	e8 ec c2 ff ff       	call   801006b0 <cprintf>
801043c4:	8b 43 a0             	mov    -0x60(%ebx),%eax
801043c7:	83 c4 10             	add    $0x10,%esp
  	if(p->state== SLEEPING)cprintf("SLEEPING\n");
801043ca:	83 f8 02             	cmp    $0x2,%eax
801043cd:	75 83                	jne    80104352 <psinfo+0x22>
801043cf:	83 ec 0c             	sub    $0xc,%esp
801043d2:	68 8f 7b 10 80       	push   $0x80107b8f
801043d7:	e8 d4 c2 ff ff       	call   801006b0 <cprintf>
801043dc:	8b 43 a0             	mov    -0x60(%ebx),%eax
801043df:	83 c4 10             	add    $0x10,%esp
  	if(p->state== RUNNABLE)cprintf("RUNNABLE\n");
801043e2:	83 f8 03             	cmp    $0x3,%eax
801043e5:	0f 85 70 ff ff ff    	jne    8010435b <psinfo+0x2b>
801043eb:	83 ec 0c             	sub    $0xc,%esp
801043ee:	68 99 7b 10 80       	push   $0x80107b99
801043f3:	e8 b8 c2 ff ff       	call   801006b0 <cprintf>
801043f8:	8b 43 a0             	mov    -0x60(%ebx),%eax
801043fb:	83 c4 10             	add    $0x10,%esp
  	if(p->state== RUNNING)cprintf("RUNNING\n");
801043fe:	83 f8 04             	cmp    $0x4,%eax
80104401:	0f 85 5d ff ff ff    	jne    80104364 <psinfo+0x34>
80104407:	83 ec 0c             	sub    $0xc,%esp
8010440a:	68 a3 7b 10 80       	push   $0x80107ba3
8010440f:	e8 9c c2 ff ff       	call   801006b0 <cprintf>
80104414:	8b 43 a0             	mov    -0x60(%ebx),%eax
80104417:	83 c4 10             	add    $0x10,%esp
  	if(p->state== ZOMBIE)cprintf("ZOMBIE\n");
8010441a:	83 f8 05             	cmp    $0x5,%eax
8010441d:	0f 85 4a ff ff ff    	jne    8010436d <psinfo+0x3d>
80104423:	83 ec 0c             	sub    $0xc,%esp
80104426:	81 c3 cc 00 00 00    	add    $0xcc,%ebx
8010442c:	68 ac 7b 10 80       	push   $0x80107bac
80104431:	e8 7a c2 ff ff       	call   801006b0 <cprintf>
80104436:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104439:	81 fb c0 70 11 80    	cmp    $0x801170c0,%ebx
8010443f:	0f 85 3a ff ff ff    	jne    8010437f <psinfo+0x4f>
  }	
...
80104454:	55                   	push   %ebp
    ...
    p = ptable.proc;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104455:	b8 54 3d 11 80       	mov    $0x80113d54,%eax
 {  
8010445a:	89 e5                	mov    %esp,%ebp
8010445c:	8b 55 08             	mov    0x8(%ebp),%edx
8010445f:	eb 13                	jmp    80104474 <numOpenFiles+0x24>
80104461:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104468:	05 cc 00 00 00       	add    $0xcc,%eax
8010446d:	3d 54 70 11 80       	cmp    $0x80117054,%eax
80104472:	74 2c                	je     801044a0 <numOpenFiles+0x50>
  	 if(p->pid==pid){   
80104474:	39 50 10             	cmp    %edx,0x10(%eax)
80104477:	75 ef                	jne    80104468 <numOpenFiles+0x18>
  			  i=0;count=0;
  			  while(p->ofile[i])
80104479:	8b 48 28             	mov    0x28(%eax),%ecx
  			  i=0;count=0;
8010447c:	31 d2                	xor    %edx,%edx
  			  while(p->ofile[i])
8010447e:	85 c9                	test   %ecx,%ecx
80104480:	74 11                	je     80104493 <numOpenFiles+0x43>
80104482:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 			   {count++;i++;}
80104488:	83 c2 01             	add    $0x1,%edx
  			  while(p->ofile[i])
8010448b:	8b 4c 90 28          	mov    0x28(%eax,%edx,4),%ecx
8010448f:	85 c9                	test   %ecx,%ecx
80104491:	75 f5                	jne    80104488 <numOpenFiles+0x38>
			 }
         }
     //release(&ptable.lock);
...
8010449e:	66 90                	xchg   %ax,%ax
     return -1;
801044a0:	ba ff ff ff ff       	mov    $0xffffffff,%edx
 }
801044a5:	5d                   	pop    %ebp
...
801044b4:	55                   	push   %ebp
    ...
    p = ptable.proc;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801044b5:	b8 54 3d 11 80       	mov    $0x80113d54,%eax
 { 
801044ba:	89 e5                	mov    %esp,%ebp
801044bc:	8b 55 08             	mov    0x8(%ebp),%edx
801044bf:	eb 13                	jmp    801044d4 <memAlloc+0x24>
801044c1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801044c8:	05 cc 00 00 00       	add    $0xcc,%eax
801044cd:	3d 54 70 11 80       	cmp    $0x80117054,%eax
801044d2:	74 14                	je     801044e8 <memAlloc+0x38>
  	 	if(p->pid==pid){
801044d4:	39 50 10             	cmp    %edx,0x10(%eax)
801044d7:	75 ef                	jne    801044c8 <memAlloc+0x18>
  	 	                 return(p->heap_sz);
801044d9:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
  	 	                }
  	 	                }
...
801044f0 <getprocesstimedetails>:
int
...
80104501:	eb 13                	jmp    80104516 <getprocesstimedetails+0x26>
80104503:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104507:	90                   	nop
80104508:	81 c3 cc 00 00 00    	add    $0xcc,%ebx
8010450e:	81 fb 54 70 11 80    	cmp    $0x80117054,%ebx
80104514:	74 76                	je     8010458c <getprocesstimedetails+0x9c>
  	 	if(p->pid==pid){
80104516:	39 73 10             	cmp    %esi,0x10(%ebx)
80104519:	75 ed                	jne    80104508 <getprocesstimedetails+0x18>
  	 		cprintf("Creation time: %d:%d:%d %d:%d:%d\n",p->create.second,p->create.minute,p->create.hour,p->create.day,p->create.month,p->create.year);
8010451b:	83 ec 04             	sub    $0x4,%esp
8010451e:	ff b3 98 00 00 00    	pushl  0x98(%ebx)
    	 for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104524:	81 c3 cc 00 00 00    	add    $0xcc,%ebx
  	 		cprintf("Creation time: %d:%d:%d %d:%d:%d\n",p->create.second,p->create.minute,p->create.hour,p->create.day,p->create.month,p->create.year);
8010452a:	ff 73 c8             	pushl  -0x38(%ebx)
8010452d:	ff 73 c4             	pushl  -0x3c(%ebx)
80104530:	ff 73 c0             	pushl  -0x40(%ebx)
80104533:	ff 73 bc             	pushl  -0x44(%ebx)
80104536:	ff 73 b8             	pushl  -0x48(%ebx)
80104539:	68 08 7c 10 80       	push   $0x80107c08
8010453e:	e8 6d c1 ff ff       	call   801006b0 <cprintf>
 			cprintf("Last Context Switched in time: %d:%d:%d %d:%d:%d\n",p->ct_out.second,p->ct_out.minute,p->ct_out.hour,p->ct_out.day,p->ct_out.month,p->ct_out.year);
80104543:	83 c4 1c             	add    $0x1c,%esp
80104546:	ff 73 fc             	pushl  -0x4(%ebx)
80104549:	ff 73 f8             	pushl  -0x8(%ebx)
8010454c:	ff 73 f4             	pushl  -0xc(%ebx)
8010454f:	ff 73 f0             	pushl  -0x10(%ebx)
80104552:	ff 73 ec             	pushl  -0x14(%ebx)
80104555:	ff 73 e8             	pushl  -0x18(%ebx)
80104558:	68 2c 7c 10 80       	push   $0x80107c2c
8010455d:	e8 4e c1 ff ff       	call   801006b0 <cprintf>
 			cprintf("Last Context Switched out time: %d:%d:%d %d:%d:%d\n",p->ct_in.second,p->ct_in.minute,p->ct_in.hour,p->ct_in.day,p->ct_in.month,p->ct_in.year);
80104562:	83 c4 1c             	add    $0x1c,%esp
80104565:	ff 73 e4             	pushl  -0x1c(%ebx)
80104568:	ff 73 e0             	pushl  -0x20(%ebx)
8010456b:	ff 73 dc             	pushl  -0x24(%ebx)
8010456e:	ff 73 d8             	pushl  -0x28(%ebx)
80104571:	ff 73 d4             	pushl  -0x2c(%ebx)
80104574:	ff 73 d0             	pushl  -0x30(%ebx)
80104577:	68 60 7c 10 80       	push   $0x80107c60
8010457c:	e8 2f c1 ff ff       	call   801006b0 <cprintf>
80104581:	83 c4 20             	add    $0x20,%esp
    	 for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104584:	81 fb 54 70 11 80    	cmp    $0x80117054,%ebx
8010458a:	75 8a                	jne    80104516 <getprocesstimedetails+0x26>
...
801045ae:	68 ac 7c 10 80       	push   $0x80107cac
...
8010460d:	e8 6e f9 ff ff       	call   80103f80 <sleep>
  while (lk->locked) {
...
8010461b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104621:	e8 6a f3 ff ff       	call   80103990 <myproc>
80104626:	8b 40 10             	mov    0x10(%eax),%eax
...
80104668:	e8 e3 fa ff ff       	call   80104150 <wakeup>
  release(&lk->lk);
...
801046c3:	e8 c8 f2 ff ff       	call   80103990 <myproc>
...
801047df:	c3                   	ret    
  if(mycpu()->ncli == 0 && mycpu()->intena)
801047e0:	e8 1b f1 ff ff       	call   80103900 <mycpu>
...
801047f5:	68 b7 7c 10 80       	push   $0x80107cb7
801047fa:	e8 91 bb ff ff       	call   80100390 <panic>
    panic("popcli");
801047ff:	83 ec 0c             	sub    $0xc,%esp
80104802:	68 ce 7c 10 80       	push   $0x80107cce
...
801048a4:	e8 57 f0 ff ff       	call   80103900 <mycpu>
...
80104907:	68 d5 7c 10 80       	push   $0x80107cd5
...
80104960:	68 dd 7c 10 80       	push   $0x80107cdd
...
80104bfb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104bfe:	e8 8d ed ff ff       	call   80103990 <myproc>
...
80104c59:	e8 32 ed ff ff       	call   80103990 <myproc>
80104c5e:	8b 55 08             	mov    0x8(%ebp),%edx
80104c61:	8b 40 18             	mov    0x18(%eax),%eax
...
80104cac:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104caf:	e8 dc ec ff ff       	call   80103990 <myproc>
...
80104d40 <syscall>:
[SYS_getprocesstimedetails] sys_getprocesstimedetails,     //decs
};
...
80104d48:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104d4b:	e8 40 ec ff ff       	call   80103990 <myproc>
...
80104d85:	ff 73 10             	pushl  0x10(%ebx)
80104d88:	68 e5 7c 10 80       	push   $0x80107ce5
...
80104ee4:	68 a8 7d 10 80       	push   $0x80107da8
...
80104efc:	68 a7 7d 10 80       	push   $0x80107da7
...
80104f11:	68 9b 7d 10 80       	push   $0x80107d9b
...
80104f2f:	68 aa 7d 10 80       	push   $0x80107daa
80104f34:	e8 57 b4 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104f39:	83 ec 0c             	sub    $0xc,%esp
80104f3c:	68 8c 7d 10 80       	push   $0x80107d8c
...
80104f74:	e8 17 ea ff ff       	call   80103990 <myproc>
...
80104fbd:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104fbf:	e8 cc e9 ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80104fc4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
80104fc8:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
...
80104fed:	8d 76 00             	lea    0x0(%esi),%esi
      curproc->ofile[fd] = f;
80104ff0:	89 74 98 28          	mov    %esi,0x28(%eax,%ebx,4)
  filedup(f);
...
80105107:	78 27                	js     80105130 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80105109:	e8 82 e8 ff ff       	call   80103990 <myproc>
8010510e:	8b 55 f0             	mov    -0x10(%ebp),%edx
  fileclose(f);
80105111:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80105114:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
8010511b:	00 
  fileclose(f);
...
8010532d:	58                   	pop    %eax
8010532e:	5a                   	pop    %edx
8010532f:	68 a8 7d 10 80       	push   $0x80107da8
...
80105348:	68 a7 7d 10 80       	push   $0x80107da7
...
80105537:	74 23                	je     8010555c <sys_open+0x9c>
  struct proc *curproc = myproc();
80105539:	e8 52 e4 ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105719:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
8010571c:	e8 6f e2 ff ff       	call   80103990 <myproc>
...
80105947:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010594a:	e8 41 e0 ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801059a0:	f3 0f 1e fb          	endbr32 
  return fork();
801059a4:	e9 97 e1 ff ff       	jmp    80103b40 <fork>
...
801059c0:	e8 8b f2 ff ff       	call   80104c50 <argint>
801059c5:	83 c4 10             	add    $0x10,%esp
801059c8:	85 c0                	test   %eax,%eax
801059ca:	78 14                	js     801059e0 <sys_exit+0x30>
...
801059d2:	e8 09 e4 ff ff       	call   80103de0 <exit>
  return 0;  // not reached
801059d7:	83 c4 10             	add    $0x10,%esp
801059da:	31 c0                	xor    %eax,%eax
}
801059dc:	c9                   	leave  
801059dd:	c3                   	ret    
...
801059fd:	6a 04                	push   $0x4
801059ff:	50                   	push   %eax
80105a00:	6a 00                	push   $0x0
80105a02:	e8 99 f2 ff ff       	call   80104ca0 <argptr>
80105a07:	83 c4 10             	add    $0x10,%esp
80105a0a:	85 c0                	test   %eax,%eax
80105a0c:	78 12                	js     80105a20 <sys_wait+0x30>
   return -1;
...
80105a14:	e8 27 e6 ff ff       	call   80104040 <wait>
...
80105a40:	e8 0b f2 ff ff       	call   80104c50 <argint>
...
80105a52:	e8 69 e7 ff ff       	call   801041c0 <kill>
...
80105a77:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105a7a:	e8 11 df ff ff       	call   80103990 <myproc>
...
80105aa3:	e8 a8 f1 ff ff       	call   80104c50 <argint>
80105aa8:	83 c4 10             	add    $0x10,%esp
80105aab:	85 c0                	test   %eax,%eax
80105aad:	78 51                	js     80105b00 <sys_sbrk+0x70>
    return -1;
  
  addr = myproc()->sz;
80105aaf:	e8 dc de ff ff       	call   80103990 <myproc>
  if(growproc(n) < 0)
80105ab4:	83 ec 0c             	sub    $0xc,%esp
  addr = myproc()->sz;
80105ab7:	8b 30                	mov    (%eax),%esi
  if(growproc(n) < 0)
80105ab9:	ff 75 e4             	pushl  -0x1c(%ebp)
80105abc:	e8 ff df ff ff       	call   80103ac0 <growproc>
80105ac1:	83 c4 10             	add    $0x10,%esp
80105ac4:	85 c0                	test   %eax,%eax
80105ac6:	78 38                	js     80105b00 <sys_sbrk+0x70>
    return -1;
  if((-1*n)>(myproc()->heap_sz))return -1;
80105ac8:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80105acb:	f7 db                	neg    %ebx
80105acd:	e8 be de ff ff       	call   80103990 <myproc>
80105ad2:	3b 98 80 00 00 00    	cmp    0x80(%eax),%ebx
80105ad8:	7f 26                	jg     80105b00 <sys_sbrk+0x70>
  myproc()->heap_sz=myproc()->heap_sz+n;
80105ada:	e8 b1 de ff ff       	call   80103990 <myproc>
80105adf:	8b 7d e4             	mov    -0x1c(%ebp),%edi
80105ae2:	8b 98 80 00 00 00    	mov    0x80(%eax),%ebx
80105ae8:	e8 a3 de ff ff       	call   80103990 <myproc>
80105aed:	01 fb                	add    %edi,%ebx
80105aef:	89 98 80 00 00 00    	mov    %ebx,0x80(%eax)
  return addr;
}
80105af5:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105af8:	89 f0                	mov    %esi,%eax
80105afa:	5b                   	pop    %ebx
80105afb:	5e                   	pop    %esi
80105afc:	5f                   	pop    %edi
80105afd:	5d                   	pop    %ebp
...
80105aff:	90                   	nop
    return -1;
80105b00:	be ff ff ff ff       	mov    $0xffffffff,%esi
80105b05:	eb ee                	jmp    80105af5 <sys_sbrk+0x65>
...
80105b21:	e8 2a f1 ff ff       	call   80104c50 <argint>
80105b26:	83 c4 10             	add    $0x10,%esp
80105b29:	85 c0                	test   %eax,%eax
80105b2b:	0f 88 86 00 00 00    	js     80105bb7 <sys_sleep+0xa7>
    return -1;
  acquire(&tickslock);
80105b31:	83 ec 0c             	sub    $0xc,%esp
80105b34:	68 60 70 11 80       	push   $0x80117060
80105b39:	e8 22 ed ff ff       	call   80104860 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105b3e:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105b41:	8b 1d a0 78 11 80    	mov    0x801178a0,%ebx
  while(ticks - ticks0 < n){
80105b47:	83 c4 10             	add    $0x10,%esp
80105b4a:	85 d2                	test   %edx,%edx
80105b4c:	75 23                	jne    80105b71 <sys_sleep+0x61>
80105b4e:	eb 50                	jmp    80105ba0 <sys_sleep+0x90>
    if(myproc()->killed){
      release(&tickslock);
      return -1;
    }
...
80105b53:	68 60 70 11 80       	push   $0x80117060
80105b58:	68 a0 78 11 80       	push   $0x801178a0
80105b5d:	e8 1e e4 ff ff       	call   80103f80 <sleep>
  while(ticks - ticks0 < n){
80105b62:	a1 a0 78 11 80       	mov    0x801178a0,%eax
...
80105b6f:	73 2f                	jae    80105ba0 <sys_sleep+0x90>
    if(myproc()->killed){
80105b71:	e8 1a de ff ff       	call   80103990 <myproc>
...
80105b80:	68 60 70 11 80       	push   $0x80117060
80105b85:	e8 96 ed ff ff       	call   80104920 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105ba3:	68 60 70 11 80       	push   $0x80117060
80105ba8:	e8 73 ed ff ff       	call   80104920 <release>
  return 0;
...
80105bc8:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105bcb:	68 60 70 11 80       	push   $0x80117060
80105bd0:	e8 8b ec ff ff       	call   80104860 <acquire>
  xticks = ticks;
80105bd5:	8b 1d a0 78 11 80    	mov    0x801178a0,%ebx
  release(&tickslock);
80105bdb:	c7 04 24 60 70 11 80 	movl   $0x80117060,(%esp)
80105be2:	e8 39 ed ff ff       	call   80104920 <release>
  return xticks;
}
...
//decs system calls below this mark
...
80105bf7:	83 ec 08             	sub    $0x8,%esp
  psinfo();
80105bfa:	e8 31 e7 ff ff       	call   80104330 <psinfo>
  return 0;
 }
...
80105c10 <sys_helloWorld>:
 int sys_helloWorld()
{
80105c10:	f3 0f 1e fb          	endbr32 
80105c14:	55                   	push   %ebp
80105c15:	89 e5                	mov    %esp,%ebp
80105c17:	83 ec 14             	sub    $0x14,%esp
 cprintf("HelloWorld");
80105c1a:	68 ed 7d 10 80       	push   $0x80107ded
80105c1f:	e8 8c aa ff ff       	call   801006b0 <cprintf>
 return 0;
 }
...
80105c40:	e8 0b f0 ff ff       	call   80104c50 <argint>
80105c45:	83 c4 10             	add    $0x10,%esp
80105c48:	85 c0                	test   %eax,%eax
80105c4a:	78 14                	js     80105c60 <sys_numOpenFiles+0x30>
...
80105c52:	e8 f9 e7 ff ff       	call   80104450 <numOpenFiles>
...
80105c80:	e8 cb ef ff ff       	call   80104c50 <argint>
80105c85:	83 c4 10             	add    $0x10,%esp
80105c88:	85 c0                	test   %eax,%eax
80105c8a:	78 14                	js     80105ca0 <sys_memAlloc+0x30>

   return -1; }
 return (memAlloc(pid));
80105c8c:	83 ec 0c             	sub    $0xc,%esp
80105c8f:	ff 75 f4             	pushl  -0xc(%ebp)
80105c92:	e8 19 e8 ff ff       	call   801044b0 <memAlloc>
...
80105cb0 <sys_getprocesstimedetails>:
...
80105d27:	c7 04 c5 a2 70 11 80 	movl   $0x8e000008,-0x7fee8f5e(,%eax,8)
80105d2e:	08 00 00 8e 
80105d32:	66 89 14 c5 a0 70 11 	mov    %dx,-0x7fee8f60(,%eax,8)
80105d39:	80 
80105d3a:	c1 ea 10             	shr    $0x10,%edx
80105d3d:	66 89 14 c5 a6 70 11 	mov    %dx,-0x7fee8f5a(,%eax,8)
80105d44:	80 
  for(i = 0; i < 256; i++)
...
80105d57:	c7 05 a2 72 11 80 08 	movl   $0xef000008,0x801172a2
80105d5e:	00 00 ef 
  initlock(&tickslock, "time");
80105d61:	68 f8 7d 10 80       	push   $0x80107df8
80105d66:	68 60 70 11 80       	push   $0x80117060
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105d6b:	66 a3 a0 72 11 80    	mov    %ax,0x801172a0
80105d71:	c1 e8 10             	shr    $0x10,%eax
80105d74:	66 a3 a6 72 11 80    	mov    %ax,0x801172a6
  initlock(&tickslock, "time");
80105d7a:	e8 61 e9 ff ff       	call   801046e0 <initlock>
}
...
80105d9f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105da3:	b8 a0 70 11 80       	mov    $0x801170a0,%eax
...
80105dd6:	0f 84 bc 01 00 00    	je     80105f98 <trap+0x1d8>
    if(myproc()->killed)
      exit(-1);
    return;
  }
...
80105de4:	3e ff 24 85 a0 7e 10 	notrack jmp *-0x7fef8160(,%eax,4)
80105deb:	80 
    lapiceoi();
    break;
...
80105dec:	e8 9f db ff ff       	call   80103990 <myproc>
80105df1:	8b 7b 38             	mov    0x38(%ebx),%edi
80105df4:	85 c0                	test   %eax,%eax
80105df6:	0f 84 13 02 00 00    	je     8010600f <trap+0x24f>
80105dfc:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105e00:	0f 84 09 02 00 00    	je     8010600f <trap+0x24f>
...
80105e0c:	e8 5f db ff ff       	call   80103970 <cpuid>
...
80105e25:	e8 66 db ff ff       	call   80103990 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105e41:	68 5c 7e 10 80       	push   $0x80107e5c
80105e46:	e8 65 a8 ff ff       	call   801006b0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105e4b:	83 c4 20             	add    $0x20,%esp
80105e4e:	e8 3d db ff ff       	call   80103990 <myproc>
...
80105e5a:	e8 31 db ff ff       	call   80103990 <myproc>
80105e5f:	85 c0                	test   %eax,%eax
80105e61:	74 1d                	je     80105e80 <trap+0xc0>
80105e63:	e8 28 db ff ff       	call   80103990 <myproc>
...
80105e7a:	0f 84 50 01 00 00    	je     80105fd0 <trap+0x210>
    exit(0);
...
80105e87:	74 0f                	je     80105e98 <trap+0xd8>
80105e89:	e8 02 db ff ff       	call   80103990 <myproc>
80105e8e:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105e92:	0f 84 e8 00 00 00    	je     80105f80 <trap+0x1c0>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e98:	e8 f3 da ff ff       	call   80103990 <myproc>
80105e9d:	85 c0                	test   %eax,%eax
80105e9f:	74 1d                	je     80105ebe <trap+0xfe>
80105ea1:	e8 ea da ff ff       	call   80103990 <myproc>
80105ea6:	8b 40 24             	mov    0x24(%eax),%eax
80105ea9:	85 c0                	test   %eax,%eax
80105eab:	74 11                	je     80105ebe <trap+0xfe>
80105ead:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105eb1:	83 e0 03             	and    $0x3,%eax
80105eb4:	66 83 f8 03          	cmp    $0x3,%ax
80105eb8:	0f 84 2a 01 00 00    	je     80105fe8 <trap+0x228>
    exit(0);
}
...
80105ec5:	c3                   	ret    
    ideintr();
80105ec6:	e8 15 c3 ff ff       	call   801021e0 <ideintr>
    lapiceoi();
80105ecb:	e8 f0 c9 ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ed0:	e8 bb da ff ff       	call   80103990 <myproc>
80105ed5:	85 c0                	test   %eax,%eax
80105ed7:	75 8a                	jne    80105e63 <trap+0xa3>
80105ed9:	eb a5                	jmp    80105e80 <trap+0xc0>
    if(cpuid() == 0){
80105edb:	e8 90 da ff ff       	call   80103970 <cpuid>
80105ee0:	85 c0                	test   %eax,%eax
80105ee2:	75 e7                	jne    80105ecb <trap+0x10b>
      acquire(&tickslock);
80105ee4:	83 ec 0c             	sub    $0xc,%esp
80105ee7:	68 60 70 11 80       	push   $0x80117060
80105eec:	e8 6f e9 ff ff       	call   80104860 <acquire>
      wakeup(&ticks);
80105ef1:	c7 04 24 a0 78 11 80 	movl   $0x801178a0,(%esp)
      ticks++;
80105ef8:	83 05 a0 78 11 80 01 	addl   $0x1,0x801178a0
      wakeup(&ticks);
80105eff:	e8 4c e2 ff ff       	call   80104150 <wakeup>
      release(&tickslock);
80105f04:	c7 04 24 60 70 11 80 	movl   $0x80117060,(%esp)
80105f0b:	e8 10 ea ff ff       	call   80104920 <release>
80105f10:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105f13:	eb b6                	jmp    80105ecb <trap+0x10b>
    kbdintr();
80105f15:	e8 66 c8 ff ff       	call   80102780 <kbdintr>
    lapiceoi();
80105f1a:	e8 a1 c9 ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105f1f:	e8 6c da ff ff       	call   80103990 <myproc>
80105f24:	85 c0                	test   %eax,%eax
80105f26:	0f 85 37 ff ff ff    	jne    80105e63 <trap+0xa3>
80105f2c:	e9 4f ff ff ff       	jmp    80105e80 <trap+0xc0>
    uartintr();
80105f31:	e8 7a 02 00 00       	call   801061b0 <uartintr>
    lapiceoi();
80105f36:	e8 85 c9 ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105f3b:	e8 50 da ff ff       	call   80103990 <myproc>
80105f40:	85 c0                	test   %eax,%eax
80105f42:	0f 85 1b ff ff ff    	jne    80105e63 <trap+0xa3>
80105f48:	e9 33 ff ff ff       	jmp    80105e80 <trap+0xc0>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105f4d:	8b 7b 38             	mov    0x38(%ebx),%edi
80105f50:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105f54:	e8 17 da ff ff       	call   80103970 <cpuid>
80105f59:	57                   	push   %edi
80105f5a:	56                   	push   %esi
80105f5b:	50                   	push   %eax
80105f5c:	68 04 7e 10 80       	push   $0x80107e04
80105f61:	e8 4a a7 ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105f66:	e8 55 c9 ff ff       	call   801028c0 <lapiceoi>
    break;
80105f6b:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105f6e:	e8 1d da ff ff       	call   80103990 <myproc>
80105f73:	85 c0                	test   %eax,%eax
80105f75:	0f 85 e8 fe ff ff    	jne    80105e63 <trap+0xa3>
80105f7b:	e9 00 ff ff ff       	jmp    80105e80 <trap+0xc0>
  if(myproc() && myproc()->state == RUNNING &&
80105f80:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105f84:	0f 85 0e ff ff ff    	jne    80105e98 <trap+0xd8>
    yield();
80105f8a:	e8 a1 df ff ff       	call   80103f30 <yield>
80105f8f:	e9 04 ff ff ff       	jmp    80105e98 <trap+0xd8>
80105f94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105f98:	e8 f3 d9 ff ff       	call   80103990 <myproc>
80105f9d:	8b 70 24             	mov    0x24(%eax),%esi
80105fa0:	85 f6                	test   %esi,%esi
80105fa2:	75 5c                	jne    80106000 <trap+0x240>
    myproc()->tf = tf;
80105fa4:	e8 e7 d9 ff ff       	call   80103990 <myproc>
80105fa9:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105fac:	e8 8f ed ff ff       	call   80104d40 <syscall>
    if(myproc()->killed)
80105fb1:	e8 da d9 ff ff       	call   80103990 <myproc>
80105fb6:	8b 48 24             	mov    0x24(%eax),%ecx
80105fb9:	85 c9                	test   %ecx,%ecx
80105fbb:	0f 84 fd fe ff ff    	je     80105ebe <trap+0xfe>
      exit(-1);
80105fc1:	c7 45 08 ff ff ff ff 	movl   $0xffffffff,0x8(%ebp)
80105fc8:	eb 25                	jmp    80105fef <trap+0x22f>
80105fca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit(0);
80105fd0:	83 ec 0c             	sub    $0xc,%esp
80105fd3:	6a 00                	push   $0x0
80105fd5:	e8 06 de ff ff       	call   80103de0 <exit>
80105fda:	83 c4 10             	add    $0x10,%esp
80105fdd:	e9 9e fe ff ff       	jmp    80105e80 <trap+0xc0>
80105fe2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit(0);
80105fe8:	c7 45 08 00 00 00 00 	movl   $0x0,0x8(%ebp)
}
...
80105ff5:	5d                   	pop    %ebp
    exit(0);
80105ff6:	e9 e5 dd ff ff       	jmp    80103de0 <exit>
80105ffb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105fff:	90                   	nop
      exit(-1);
80106000:	83 ec 0c             	sub    $0xc,%esp
80106003:	6a ff                	push   $0xffffffff
80106005:	e8 d6 dd ff ff       	call   80103de0 <exit>
8010600a:	83 c4 10             	add    $0x10,%esp
8010600d:	eb 95                	jmp    80105fa4 <trap+0x1e4>
8010600f:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106012:	e8 59 d9 ff ff       	call   80103970 <cpuid>
80106017:	83 ec 0c             	sub    $0xc,%esp
8010601a:	56                   	push   %esi
8010601b:	57                   	push   %edi
8010601c:	50                   	push   %eax
8010601d:	ff 73 30             	pushl  0x30(%ebx)
80106020:	68 28 7e 10 80       	push   $0x80107e28
80106025:	e8 86 a6 ff ff       	call   801006b0 <cprintf>
      panic("trap");
8010602a:	83 c4 14             	add    $0x14,%esp
8010602d:	68 fd 7d 10 80       	push   $0x80107dfd
80106032:	e8 59 a3 ff ff       	call   80100390 <panic>
...
80106040:	f3 0f 1e fb          	endbr32 
  if(!uart)
80106044:	a1 bc b5 10 80       	mov    0x8010b5bc,%eax
...
80106095:	e8 46 c8 ff ff       	call   801028e0 <microdelay>
...
8010611b:	74 52                	je     8010616f <uartinit+0xaf>
  uart = 1;
8010611d:	c7 05 bc b5 10 80 01 	movl   $0x1,0x8010b5bc
80106124:	00 00 00 
...
80106133:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80106138:	bb 20 7f 10 80       	mov    $0x80107f20,%ebx
  ioapicenable(IRQ_COM1, 0);
8010613d:	6a 00                	push   $0x0
8010613f:	6a 04                	push   $0x4
80106141:	e8 ea c2 ff ff       	call   80102430 <ioapicenable>
...
80106150:	0f b6 73 01          	movzbl 0x1(%ebx),%esi
  if(!uart)
80106154:	8b 15 bc b5 10 80    	mov    0x8010b5bc,%edx
...
80106184:	55                   	push   %ebp
  if(!uart)
80106185:	8b 15 bc b5 10 80    	mov    0x8010b5bc,%edx
{
...
801061ef:	6a 04                	push   $0x4
  jmp alltraps
801061f1:	e9 f1 fa ff ff       	jmp    80105ce7 <alltraps>
...
801061f8:	6a 05                	push   $0x5
  jmp alltraps
801061fa:	e9 e8 fa ff ff       	jmp    80105ce7 <alltraps>
...
80106201:	6a 06                	push   $0x6
  jmp alltraps
80106203:	e9 df fa ff ff       	jmp    80105ce7 <alltraps>
...
8010620a:	6a 07                	push   $0x7
  jmp alltraps
8010620c:	e9 d6 fa ff ff       	jmp    80105ce7 <alltraps>
...
80106211:	6a 08                	push   $0x8
  jmp alltraps
80106213:	e9 cf fa ff ff       	jmp    80105ce7 <alltraps>
...
8010621a:	6a 09                	push   $0x9
  jmp alltraps
8010621c:	e9 c6 fa ff ff       	jmp    80105ce7 <alltraps>
...
80106221:	6a 0a                	push   $0xa
  jmp alltraps
80106223:	e9 bf fa ff ff       	jmp    80105ce7 <alltraps>
...
80106228:	6a 0b                	push   $0xb
  jmp alltraps
8010622a:	e9 b8 fa ff ff       	jmp    80105ce7 <alltraps>
...
8010622f:	6a 0c                	push   $0xc
  jmp alltraps
80106231:	e9 b1 fa ff ff       	jmp    80105ce7 <alltraps>
...
80106236:	6a 0d                	push   $0xd
  jmp alltraps
80106238:	e9 aa fa ff ff       	jmp    80105ce7 <alltraps>
...
8010623d:	6a 0e                	push   $0xe
  jmp alltraps
8010623f:	e9 a3 fa ff ff       	jmp    80105ce7 <alltraps>
...
80106246:	6a 0f                	push   $0xf
  jmp alltraps
80106248:	e9 9a fa ff ff       	jmp    80105ce7 <alltraps>
...
8010624f:	6a 10                	push   $0x10
  jmp alltraps
80106251:	e9 91 fa ff ff       	jmp    80105ce7 <alltraps>
...
80106619:	6a 7c                	push   $0x7c
  jmp alltraps
8010661b:	e9 c7 f6 ff ff       	jmp    80105ce7 <alltraps>
...
80106622:	6a 7d                	push   $0x7d
  jmp alltraps
80106624:	e9 be f6 ff ff       	jmp    80105ce7 <alltraps>
...
8010662b:	6a 7e                	push   $0x7e
  jmp alltraps
8010662d:	e9 b5 f6 ff ff       	jmp    80105ce7 <alltraps>
...
80106c19:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106c1e:	e9 c4 f0 ff ff       	jmp    80105ce7 <alltraps>
...
80106c25:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106c2a:	e9 b8 f0 ff ff       	jmp    80105ce7 <alltraps>
...
80106c31:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106c36:	e9 ac f0 ff ff       	jmp    80105ce7 <alltraps>
...
80106c45:	89 d6                	mov    %edx,%esi
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80106c47:	c1 ea 16             	shr    $0x16,%edx
{
...
80106c4e:	83 ec 0c             	sub    $0xc,%esp
  if(*pde & PTE_P){
80106c51:	8b 1f                	mov    (%edi),%ebx
80106c53:	f6 c3 01             	test   $0x1,%bl
80106c56:	74 28                	je     80106c80 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106c58:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80106c5e:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
...
80106c66:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return &pgtab[PTX(va)];
80106c69:	c1 e8 0a             	shr    $0xa,%eax
80106c6c:	25 fc 0f 00 00       	and    $0xffc,%eax
80106c71:	01 d8                	add    %ebx,%eax
}
80106c73:	5b                   	pop    %ebx
80106c74:	5e                   	pop    %esi
80106c75:	5f                   	pop    %edi
...
80106c84:	e8 a7 b9 ff ff       	call   80102630 <kalloc>
80106c89:	89 c3                	mov    %eax,%ebx
...
80106c9a:	e8 d1 dc ff ff       	call   80104970 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106cc4:	89 c7                	mov    %eax,%edi
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106cc6:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
{
80106cca:	56                   	push   %esi
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106ccb:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  a = (char*)PGROUNDDOWN((uint)va);
80106cd0:	89 d6                	mov    %edx,%esi
{
80106cd2:	53                   	push   %ebx
  a = (char*)PGROUNDDOWN((uint)va);
80106cd3:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
{
80106cd9:	83 ec 1c             	sub    $0x1c,%esp
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106cdc:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106cdf:	8b 45 08             	mov    0x8(%ebp),%eax
80106ce2:	29 f0                	sub    %esi,%eax
80106ce4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106ce7:	eb 1f                	jmp    80106d08 <mappages+0x48>
...
80106d00:	74 2e                	je     80106d30 <mappages+0x70>
      break;
    a += PGSIZE;
...
80106d17:	e8 24 ff ff ff       	call   80106c40 <walkpgdir>
80106d1c:	85 c0                	test   %eax,%eax
80106d1e:	75 d0                	jne    80106cf0 <mappages+0x30>
    pa += PGSIZE;
  }
  return 0;
}
...
80106d3d:	68 28 7f 10 80       	push   $0x80107f28
...
80106d55:	89 c6                	mov    %eax,%esi
80106d57:	53                   	push   %ebx
80106d58:	89 d3                	mov    %edx,%ebx
  uint a, pa;
  ...
  a = PGROUNDUP(newsz);
80106d5a:	8d 91 ff 0f 00 00    	lea    0xfff(%ecx),%edx
80106d60:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106d66:	83 ec 1c             	sub    $0x1c,%esp
80106d69:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106d6c:	39 da                	cmp    %ebx,%edx
80106d6e:	73 5b                	jae    80106dcb <deallocuvm.part.0+0x7b>
80106d70:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
80106d73:	89 d7                	mov    %edx,%edi
80106d75:	eb 14                	jmp    80106d8b <deallocuvm.part.0+0x3b>
80106d77:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106d7e:	66 90                	xchg   %ax,%ax
80106d80:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106d86:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
80106d89:	76 40                	jbe    80106dcb <deallocuvm.part.0+0x7b>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106d8b:	31 c9                	xor    %ecx,%ecx
80106d8d:	89 fa                	mov    %edi,%edx
80106d8f:	89 f0                	mov    %esi,%eax
80106d91:	e8 aa fe ff ff       	call   80106c40 <walkpgdir>
80106d96:	89 c3                	mov    %eax,%ebx
    if(!pte)
80106d98:	85 c0                	test   %eax,%eax
80106d9a:	74 44                	je     80106de0 <deallocuvm.part.0+0x90>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
    else if((*pte & PTE_P) != 0){
80106d9c:	8b 00                	mov    (%eax),%eax
80106d9e:	a8 01                	test   $0x1,%al
80106da0:	74 de                	je     80106d80 <deallocuvm.part.0+0x30>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106da2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106da7:	74 47                	je     80106df0 <deallocuvm.part.0+0xa0>
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
80106da9:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
80106dac:	05 00 00 00 80       	add    $0x80000000,%eax
80106db1:	81 c7 00 10 00 00    	add    $0x1000,%edi
      kfree(v);
80106db7:	50                   	push   %eax
80106db8:	e8 b3 b6 ff ff       	call   80102470 <kfree>
      *pte = 0;
80106dbd:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
80106dc3:	83 c4 10             	add    $0x10,%esp
  for(; a  < oldsz; a += PGSIZE){
80106dc6:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
80106dc9:	77 c0                	ja     80106d8b <deallocuvm.part.0+0x3b>
    }
  }
  return newsz;
}
80106dcb:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80106de2:	81 e2 00 00 c0 ff    	and    $0xffc00000,%edx
80106de8:	8d ba 00 00 40 00    	lea    0x400000(%edx),%edi
80106dee:	eb 96                	jmp    80106d86 <deallocuvm.part.0+0x36>
        panic("kfree");
80106df0:	83 ec 0c             	sub    $0xc,%esp
80106df3:	68 e6 77 10 80       	push   $0x801077e6
...
80106e07:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106e0a:	e8 61 cb ff ff       	call   80103970 <cpuid>
  pd[0] = size-1;
80106e0f:	ba 2f 00 00 00       	mov    $0x2f,%edx
80106e14:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80106e1a:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106e1e:	c7 80 f8 37 11 80 ff 	movl   $0xffff,-0x7feec808(%eax)
80106e25:	ff 00 00 
80106e28:	c7 80 fc 37 11 80 00 	movl   $0xcf9a00,-0x7feec804(%eax)
80106e2f:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106e32:	c7 80 00 38 11 80 ff 	movl   $0xffff,-0x7feec800(%eax)
80106e39:	ff 00 00 
80106e3c:	c7 80 04 38 11 80 00 	movl   $0xcf9200,-0x7feec7fc(%eax)
80106e43:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106e46:	c7 80 08 38 11 80 ff 	movl   $0xffff,-0x7feec7f8(%eax)
80106e4d:	ff 00 00 
80106e50:	c7 80 0c 38 11 80 00 	movl   $0xcffa00,-0x7feec7f4(%eax)
80106e57:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106e5a:	c7 80 10 38 11 80 ff 	movl   $0xffff,-0x7feec7f0(%eax)
80106e61:	ff 00 00 
80106e64:	c7 80 14 38 11 80 00 	movl   $0xcff200,-0x7feec7ec(%eax)
80106e6b:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106e6e:	05 f0 37 11 80       	add    $0x801137f0,%eax
  pd[1] = (uint)p;
80106e73:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80106e77:	c1 e8 10             	shr    $0x10,%eax
80106e7a:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
80106e7e:	8d 45 f2             	lea    -0xe(%ebp),%eax
80106e81:	0f 01 10             	lgdtl  (%eax)
}
80106e84:	c9                   	leave  
80106e85:	c3                   	ret    
...
80106e94:	a1 a4 78 11 80       	mov    0x801178a4,%eax
...
80106ec2:	0f 84 cb 00 00 00    	je     80106f93 <switchuvm+0xe3>
  if(p->kstack == 0)
80106ec8:	8b 46 08             	mov    0x8(%esi),%eax
80106ecb:	85 c0                	test   %eax,%eax
80106ecd:	0f 84 da 00 00 00    	je     80106fad <switchuvm+0xfd>
  if(p->pgdir == 0)
80106ed3:	8b 46 04             	mov    0x4(%esi),%eax
80106ed6:	85 c0                	test   %eax,%eax
80106ed8:	0f 84 c2 00 00 00    	je     80106fa0 <switchuvm+0xf0>
  pushcli();
80106ede:	e8 7d d8 ff ff       	call   80104760 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106ee3:	e8 18 ca ff ff       	call   80103900 <mycpu>
80106ee8:	89 c3                	mov    %eax,%ebx
80106eea:	e8 11 ca ff ff       	call   80103900 <mycpu>
80106eef:	89 c7                	mov    %eax,%edi
80106ef1:	e8 0a ca ff ff       	call   80103900 <mycpu>
80106ef6:	83 c7 08             	add    $0x8,%edi
80106ef9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106efc:	e8 ff c9 ff ff       	call   80103900 <mycpu>
80106f01:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106f04:	ba 67 00 00 00       	mov    $0x67,%edx
80106f09:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106f10:	83 c0 08             	add    $0x8,%eax
80106f13:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106f1a:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106f1f:	83 c1 08             	add    $0x8,%ecx
80106f22:	c1 e8 18             	shr    $0x18,%eax
80106f25:	c1 e9 10             	shr    $0x10,%ecx
80106f28:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
80106f2e:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80106f34:	b9 99 40 00 00       	mov    $0x4099,%ecx
80106f39:	66 89 8b 9d 00 00 00 	mov    %cx,0x9d(%ebx)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106f40:	bb 10 00 00 00       	mov    $0x10,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
80106f45:	e8 b6 c9 ff ff       	call   80103900 <mycpu>
80106f4a:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106f51:	e8 aa c9 ff ff       	call   80103900 <mycpu>
80106f56:	66 89 58 10          	mov    %bx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106f5a:	8b 5e 08             	mov    0x8(%esi),%ebx
80106f5d:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106f63:	e8 98 c9 ff ff       	call   80103900 <mycpu>
80106f68:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106f6b:	e8 90 c9 ff ff       	call   80103900 <mycpu>
80106f70:	66 89 78 6e          	mov    %di,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80106f74:	b8 28 00 00 00       	mov    $0x28,%eax
80106f79:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106f7c:	8b 46 04             	mov    0x4(%esi),%eax
80106f7f:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106f84:	0f 22 d8             	mov    %eax,%cr3
}
...
80106f8d:	5d                   	pop    %ebp
  popcli();
80106f8e:	e9 1d d8 ff ff       	jmp    801047b0 <popcli>
    panic("switchuvm: no process");
80106f93:	83 ec 0c             	sub    $0xc,%esp
80106f96:	68 2e 7f 10 80       	push   $0x80107f2e
80106f9b:	e8 f0 93 ff ff       	call   80100390 <panic>
    panic("switchuvm: no pgdir");
80106fa0:	83 ec 0c             	sub    $0xc,%esp
80106fa3:	68 59 7f 10 80       	push   $0x80107f59
80106fa8:	e8 e3 93 ff ff       	call   80100390 <panic>
    panic("switchuvm: no kstack");
80106fad:	83 ec 0c             	sub    $0xc,%esp
80106fb0:	68 44 7f 10 80       	push   $0x80107f44
80106fb5:	e8 d6 93 ff ff       	call   80100390 <panic>
...
80106fd0:	8b 75 10             	mov    0x10(%ebp),%esi
80106fd3:	8b 7d 08             	mov    0x8(%ebp),%edi
80106fd6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80106fd9:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106fdf:	77 4b                	ja     8010702c <inituvm+0x6c>
  mem = kalloc();
80106fe1:	e8 4a b6 ff ff       	call   80102630 <kalloc>
  memset(mem, 0, PGSIZE);
80106fe6:	83 ec 04             	sub    $0x4,%esp
80106fe9:	68 00 10 00 00       	push   $0x1000
  mem = kalloc();
80106fee:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106ff0:	6a 00                	push   $0x0
80106ff2:	50                   	push   %eax
80106ff3:	e8 78 d9 ff ff       	call   80104970 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106ff8:	58                   	pop    %eax
80106ff9:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106fff:	5a                   	pop    %edx
80107000:	6a 06                	push   $0x6
80107002:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107007:	31 d2                	xor    %edx,%edx
80107009:	50                   	push   %eax
8010700a:	89 f8                	mov    %edi,%eax
8010700c:	e8 af fc ff ff       	call   80106cc0 <mappages>
  memmove(mem, init, sz);
80107011:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107014:	89 75 10             	mov    %esi,0x10(%ebp)
80107017:	83 c4 10             	add    $0x10,%esp
8010701a:	89 5d 08             	mov    %ebx,0x8(%ebp)
8010701d:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
80107026:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80107027:	e9 e4 d9 ff ff       	jmp    80104a10 <memmove>
    panic("inituvm: more than a page");
8010702c:	83 ec 0c             	sub    $0xc,%esp
8010702f:	68 6d 7f 10 80       	push   $0x80107f6d
...
80107050:	8b 75 18             	mov    0x18(%ebp),%esi
  if((uint) addr % PGSIZE != 0)
80107053:	a9 ff 0f 00 00       	test   $0xfff,%eax
80107058:	0f 85 99 00 00 00    	jne    801070f7 <loaduvm+0xb7>
  for(i = 0; i < sz; i += PGSIZE){
8010705e:	01 f0                	add    %esi,%eax
80107060:	89 f3                	mov    %esi,%ebx
80107062:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80107065:	8b 45 14             	mov    0x14(%ebp),%eax
80107068:	01 f0                	add    %esi,%eax
8010706a:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
8010706d:	85 f6                	test   %esi,%esi
8010706f:	75 15                	jne    80107086 <loaduvm+0x46>
80107071:	eb 6d                	jmp    801070e0 <loaduvm+0xa0>
80107073:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80107077:	90                   	nop
80107078:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
8010707e:	89 f0                	mov    %esi,%eax
80107080:	29 d8                	sub    %ebx,%eax
80107082:	39 c6                	cmp    %eax,%esi
80107084:	76 5a                	jbe    801070e0 <loaduvm+0xa0>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107086:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80107089:	8b 45 08             	mov    0x8(%ebp),%eax
8010708c:	31 c9                	xor    %ecx,%ecx
8010708e:	29 da                	sub    %ebx,%edx
80107090:	e8 ab fb ff ff       	call   80106c40 <walkpgdir>
80107095:	85 c0                	test   %eax,%eax
80107097:	74 51                	je     801070ea <loaduvm+0xaa>
    pa = PTE_ADDR(*pte);
...
801070bb:	ff 75 10             	pushl  0x10(%ebp)
801070be:	e8 9d a9 ff ff       	call   80101a60 <readi>
801070c3:	83 c4 10             	add    $0x10,%esp
801070c6:	39 f8                	cmp    %edi,%eax
801070c8:	74 ae                	je     80107078 <loaduvm+0x38>
}
...
801070ed:	68 87 7f 10 80       	push   $0x80107f87
801070f2:	e8 99 92 ff ff       	call   80100390 <panic>
    panic("loaduvm: addr must be page aligned");
801070f7:	83 ec 0c             	sub    $0xc,%esp
801070fa:	68 28 80 10 80       	push   $0x80108028
801070ff:	e8 8c 92 ff ff       	call   80100390 <panic>
...
{
80107120:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(newsz >= KERNBASE)
80107123:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107126:	85 c0                	test   %eax,%eax
80107128:	0f 88 b2 00 00 00    	js     801071e0 <allocuvm+0xd0>
  if(newsz < oldsz)
8010712e:	3b 45 0c             	cmp    0xc(%ebp),%eax
    return oldsz;
80107131:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80107134:	0f 82 96 00 00 00    	jb     801071d0 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
8010713a:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80107140:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80107146:	39 75 10             	cmp    %esi,0x10(%ebp)
80107149:	77 40                	ja     8010718b <allocuvm+0x7b>
8010714b:	e9 83 00 00 00       	jmp    801071d3 <allocuvm+0xc3>
    memset(mem, 0, PGSIZE);
80107150:	83 ec 04             	sub    $0x4,%esp
80107153:	68 00 10 00 00       	push   $0x1000
80107158:	6a 00                	push   $0x0
8010715a:	50                   	push   %eax
8010715b:	e8 10 d8 ff ff       	call   80104970 <memset>
...
80107174:	e8 47 fb ff ff       	call   80106cc0 <mappages>
...
80107189:	76 48                	jbe    801071d3 <allocuvm+0xc3>
    mem = kalloc();
8010718b:	e8 a0 b4 ff ff       	call   80102630 <kalloc>
...
80107199:	68 a5 7f 10 80       	push   $0x80107fa5
8010719e:	e8 0d 95 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
801071b5:	e8 96 fb ff ff       	call   80106d50 <deallocuvm.part.0>
      return 0;
...
801071fb:	68 bd 7f 10 80       	push   $0x80107fbd
80107200:	e8 ab 94 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
80107217:	e8 34 fb ff ff       	call   80106d50 <deallocuvm.part.0>
      kfree(mem);
8010721c:	83 ec 0c             	sub    $0xc,%esp
8010721f:	53                   	push   %ebx
80107220:	e8 4b b2 ff ff       	call   80102470 <kfree>
      return 0;
...
80107247:	8b 55 0c             	mov    0xc(%ebp),%edx
8010724a:	8b 4d 10             	mov    0x10(%ebp),%ecx
8010724d:	8b 45 08             	mov    0x8(%ebp),%eax
  if(newsz >= oldsz)
80107250:	39 d1                	cmp    %edx,%ecx
80107252:	73 0c                	jae    80107260 <deallocuvm+0x20>
}
80107254:	5d                   	pop    %ebp
80107255:	e9 f6 fa ff ff       	jmp    80106d50 <deallocuvm.part.0>
...
80107282:	74 55                	je     801072d9 <freevm+0x69>
  if(newsz >= oldsz)
80107284:	31 c9                	xor    %ecx,%ecx
80107286:	ba 00 00 00 80       	mov    $0x80000000,%edx
8010728b:	89 f0                	mov    %esi,%eax
8010728d:	89 f3                	mov    %esi,%ebx
8010728f:	e8 bc fa ff ff       	call   80106d50 <deallocuvm.part.0>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80107294:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
8010729a:	eb 0b                	jmp    801072a7 <freevm+0x37>
...
801072be:	e8 ad b1 ff ff       	call   80102470 <kfree>
...
801072d3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
801072d4:	e9 97 b1 ff ff       	jmp    80102470 <kfree>
    panic("freevm: no pgdir");
801072d9:	83 ec 0c             	sub    $0xc,%esp
801072dc:	68 d9 7f 10 80       	push   $0x80107fd9
...
801072f7:	56                   	push   %esi
801072f8:	53                   	push   %ebx
  if((pgdir = (pde_t*)kalloc()) == 0)
801072f9:	e8 32 b3 ff ff       	call   80102630 <kalloc>
801072fe:	89 c6                	mov    %eax,%esi
80107300:	85 c0                	test   %eax,%eax
80107302:	74 42                	je     80107346 <setupkvm+0x56>
  memset(pgdir, 0, PGSIZE);
80107304:	83 ec 04             	sub    $0x4,%esp
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107307:	bb 20 b4 10 80       	mov    $0x8010b420,%ebx
  memset(pgdir, 0, PGSIZE);
8010730c:	68 00 10 00 00       	push   $0x1000
80107311:	6a 00                	push   $0x0
80107313:	50                   	push   %eax
80107314:	e8 57 d6 ff ff       	call   80104970 <memset>
80107319:	83 c4 10             	add    $0x10,%esp
                (uint)k->phys_start, k->perm) < 0) {
8010731c:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
8010731f:	83 ec 08             	sub    $0x8,%esp
80107322:	8b 4b 08             	mov    0x8(%ebx),%ecx
80107325:	ff 73 0c             	pushl  0xc(%ebx)
80107328:	8b 13                	mov    (%ebx),%edx
8010732a:	50                   	push   %eax
8010732b:	29 c1                	sub    %eax,%ecx
8010732d:	89 f0                	mov    %esi,%eax
8010732f:	e8 8c f9 ff ff       	call   80106cc0 <mappages>
80107334:	83 c4 10             	add    $0x10,%esp
80107337:	85 c0                	test   %eax,%eax
80107339:	78 15                	js     80107350 <setupkvm+0x60>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010733b:	83 c3 10             	add    $0x10,%ebx
8010733e:	81 fb 60 b4 10 80    	cmp    $0x8010b460,%ebx
80107344:	75 d6                	jne    8010731c <setupkvm+0x2c>
}
80107346:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
80107377:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
8010737a:	e8 71 ff ff ff       	call   801072f0 <setupkvm>
8010737f:	a3 a4 78 11 80       	mov    %eax,0x801178a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80107384:	05 00 00 00 80       	add    $0x80000000,%eax
80107389:	0f 22 d8             	mov    %eax,%cr3
}
8010738c:	c9                   	leave  
8010738d:	c3                   	ret    
...
801073a2:	e8 99 f8 ff ff       	call   80106c40 <walkpgdir>
  if(pte == 0)
801073a7:	85 c0                	test   %eax,%eax
801073a9:	74 05                	je     801073b0 <clearpteu+0x20>
    panic("clearpteu");
  *pte &= ~PTE_U;
801073ab:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
801073ae:	c9                   	leave  
801073af:	c3                   	ret    
    panic("clearpteu");
801073b0:	83 ec 0c             	sub    $0xc,%esp
801073b3:	68 ea 7f 10 80       	push   $0x80107fea
...
801073ca:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
801073cd:	e8 1e ff ff ff       	call   801072f0 <setupkvm>
801073d2:	89 45 e0             	mov    %eax,-0x20(%ebp)
801073d5:	85 c0                	test   %eax,%eax
801073d7:	0f 84 9b 00 00 00    	je     80107478 <copyuvm+0xb8>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
801073dd:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801073e0:	85 c9                	test   %ecx,%ecx
801073e2:	0f 84 90 00 00 00    	je     80107478 <copyuvm+0xb8>
801073e8:	31 f6                	xor    %esi,%esi
801073ea:	eb 46                	jmp    80107432 <copyuvm+0x72>
...
80107400:	e8 0b d6 ff ff       	call   80104a10 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80107405:	58                   	pop    %eax
80107406:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
8010740c:	5a                   	pop    %edx
8010740d:	ff 75 e4             	pushl  -0x1c(%ebp)
80107410:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107415:	89 f2                	mov    %esi,%edx
80107417:	50                   	push   %eax
80107418:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010741b:	e8 a0 f8 ff ff       	call   80106cc0 <mappages>
80107420:	83 c4 10             	add    $0x10,%esp
80107423:	85 c0                	test   %eax,%eax
80107425:	78 61                	js     80107488 <copyuvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
80107427:	81 c6 00 10 00 00    	add    $0x1000,%esi
8010742d:	39 75 0c             	cmp    %esi,0xc(%ebp)
80107430:	76 46                	jbe    80107478 <copyuvm+0xb8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80107432:	8b 45 08             	mov    0x8(%ebp),%eax
80107435:	31 c9                	xor    %ecx,%ecx
80107437:	89 f2                	mov    %esi,%edx
80107439:	e8 02 f8 ff ff       	call   80106c40 <walkpgdir>
8010743e:	85 c0                	test   %eax,%eax
80107440:	74 61                	je     801074a3 <copyuvm+0xe3>
    if(!(*pte & PTE_P))
80107442:	8b 00                	mov    (%eax),%eax
80107444:	a8 01                	test   $0x1,%al
80107446:	74 4e                	je     80107496 <copyuvm+0xd6>
    pa = PTE_ADDR(*pte);
80107448:	89 c7                	mov    %eax,%edi
    flags = PTE_FLAGS(*pte);
8010744a:	25 ff 0f 00 00       	and    $0xfff,%eax
8010744f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80107452:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107458:	e8 d3 b1 ff ff       	call   80102630 <kalloc>
8010745d:	89 c3                	mov    %eax,%ebx
8010745f:	85 c0                	test   %eax,%eax
80107461:	75 8d                	jne    801073f0 <copyuvm+0x30>
    }
  }
  return d;
...
80107466:	ff 75 e0             	pushl  -0x20(%ebp)
80107469:	e8 02 fe ff ff       	call   80107270 <freevm>
  return 0;
8010746e:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
8010748c:	e8 df af ff ff       	call   80102470 <kfree>
      goto bad;
80107491:	83 c4 10             	add    $0x10,%esp
80107494:	eb cd                	jmp    80107463 <copyuvm+0xa3>
      panic("copyuvm: page not present");
80107496:	83 ec 0c             	sub    $0xc,%esp
80107499:	68 0e 80 10 80       	push   $0x8010800e
8010749e:	e8 ed 8e ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
801074a3:	83 ec 0c             	sub    $0xc,%esp
801074a6:	68 f4 7f 10 80       	push   $0x80107ff4
...
801074c2:	e8 79 f7 ff ff       	call   80106c40 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
801074ca:	89 c2                	mov    %eax,%edx
  return (char*)P2V(PTE_ADDR(*pte));
801074cc:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((*pte & PTE_U) == 0)
801074d1:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
801074d4:	05 00 00 00 80       	add    $0x80000000,%eax
801074d9:	83 fa 05             	cmp    $0x5,%edx
801074dc:	ba 00 00 00 00       	mov    $0x0,%edx
801074e1:	0f 45 c2             	cmovne %edx,%eax
}
801074e4:	c3                   	ret    
801074e5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
801074fd:	8b 75 14             	mov    0x14(%ebp),%esi
80107500:	8b 55 0c             	mov    0xc(%ebp),%edx
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
80107503:	85 f6                	test   %esi,%esi
80107505:	75 3c                	jne    80107543 <copyout+0x53>
80107507:	eb 67                	jmp    80107570 <copyout+0x80>
80107509:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
80107510:	8b 55 0c             	mov    0xc(%ebp),%edx
80107513:	89 fb                	mov    %edi,%ebx
80107515:	29 d3                	sub    %edx,%ebx
80107517:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
8010751d:	39 f3                	cmp    %esi,%ebx
8010751f:	0f 47 de             	cmova  %esi,%ebx
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80107522:	29 fa                	sub    %edi,%edx
80107524:	83 ec 04             	sub    $0x4,%esp
80107527:	01 c2                	add    %eax,%edx
80107529:	53                   	push   %ebx
8010752a:	ff 75 10             	pushl  0x10(%ebp)
8010752d:	52                   	push   %edx
8010752e:	e8 dd d4 ff ff       	call   80104a10 <memmove>
    len -= n;
    buf += n;
80107533:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
80107536:	8d 97 00 10 00 00    	lea    0x1000(%edi),%edx
  while(len > 0){
8010753c:	83 c4 10             	add    $0x10,%esp
8010753f:	29 de                	sub    %ebx,%esi
80107541:	74 2d                	je     80107570 <copyout+0x80>
    va0 = (uint)PGROUNDDOWN(va);
80107543:	89 d7                	mov    %edx,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
80107545:	83 ec 08             	sub    $0x8,%esp
    va0 = (uint)PGROUNDDOWN(va);
80107548:	89 55 0c             	mov    %edx,0xc(%ebp)
8010754b:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
80107551:	57                   	push   %edi
80107552:	ff 75 08             	pushl  0x8(%ebp)
80107555:	e8 56 ff ff ff       	call   801074b0 <uva2ka>
    if(pa0 == 0)
8010755a:	83 c4 10             	add    $0x10,%esp
8010755d:	85 c0                	test   %eax,%eax
8010755f:	75 af                	jne    80107510 <copyout+0x20>
  }
  return 0;
}
80107561:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
