...
00000170 <panic>:
{
  ...
  exit(-1);
     189:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
...
000001a0 <runcmd>:
{
  ...
  if(cmd == 0)
     ...
     1b0:	74 13                	je     1c5 <runcmd+0x25>
  switch(cmd->type){
     1b2:	83 3b 05             	cmpl   $0x5,(%ebx)
     1b5:	0f 87 24 01 00 00    	ja     2df <runcmd+0x13f>
     1bb:	8b 03                	mov    (%ebx),%eax
     1bd:	3e ff 24 85 70 13 00 	notrack jmp *0x1370(,%eax,4)
     1c4:	00 
    exit(-1);
     1c5:	83 ec 0c             	sub    $0xc,%esp
     1c8:	6a ff                	push   $0xffffffff
     1ca:	e8 04 0c 00 00       	call   dd3 <exit>
  pid = fork();
     1cf:	e8 f7 0b 00 00       	call   dcb <fork>
  if(pid == -1)
     1d4:	83 f8 ff             	cmp    $0xffffffff,%eax
     1d7:	0f 84 94 01 00 00    	je     371 <runcmd+0x1d1>
    if(fork1() == 0)
     1dd:	85 c0                	test   %eax,%eax
     1df:	0f 84 ef 00 00 00    	je     2d4 <runcmd+0x134>
  exit(0);
     1e5:	83 ec 0c             	sub    $0xc,%esp
     1e8:	6a 00                	push   $0x0
     1ea:	e8 e4 0b 00 00       	call   dd3 <exit>
    if(ecmd->argv[0] == 0)
     1ef:	8b 43 04             	mov    0x4(%ebx),%eax
     1f2:	85 c0                	test   %eax,%eax
     1f4:	74 cf                	je     1c5 <runcmd+0x25>
    exec(ecmd->argv[0], ecmd->argv);
     1f6:	8d 53 04             	lea    0x4(%ebx),%edx
     1f9:	51                   	push   %ecx
     1fa:	51                   	push   %ecx
     1fb:	52                   	push   %edx
     1fc:	50                   	push   %eax
     1fd:	e8 09 0c 00 00       	call   e0b <exec>
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     202:	83 c4 0c             	add    $0xc,%esp
     205:	ff 73 04             	pushl  0x4(%ebx)
     208:	68 c2 12 00 00       	push   $0x12c2
     20d:	6a 02                	push   $0x2
     20f:	e8 3c 0d 00 00       	call   f50 <printf>
    break;
     214:	83 c4 10             	add    $0x10,%esp
     217:	eb cc                	jmp    1e5 <runcmd+0x45>
    if(pipe(p) < 0)
     219:	83 ec 0c             	sub    $0xc,%esp
     21c:	8d 45 f0             	lea    -0x10(%ebp),%eax
     21f:	50                   	push   %eax
     220:	e8 be 0b 00 00       	call   de3 <pipe>
     225:	83 c4 10             	add    $0x10,%esp
     228:	85 c0                	test   %eax,%eax
     22a:	0f 88 d8 00 00 00    	js     308 <runcmd+0x168>
  pid = fork();
     230:	e8 96 0b 00 00       	call   dcb <fork>
  if(pid == -1)
     235:	83 f8 ff             	cmp    $0xffffffff,%eax
     238:	0f 84 33 01 00 00    	je     371 <runcmd+0x1d1>
    if(fork1() == 0){
     23e:	85 c0                	test   %eax,%eax
     240:	0f 84 cf 00 00 00    	je     315 <runcmd+0x175>
  pid = fork();
     246:	e8 80 0b 00 00       	call   dcb <fork>
  if(pid == -1)
     24b:	83 f8 ff             	cmp    $0xffffffff,%eax
     24e:	0f 84 1d 01 00 00    	je     371 <runcmd+0x1d1>
    if(fork1() == 0){
     254:	85 c0                	test   %eax,%eax
     256:	0f 84 e7 00 00 00    	je     343 <runcmd+0x1a3>
    close(p[0]);
     25c:	83 ec 0c             	sub    $0xc,%esp
     25f:	ff 75 f0             	pushl  -0x10(%ebp)
     262:	e8 94 0b 00 00       	call   dfb <close>
    close(p[1]);
     267:	58                   	pop    %eax
     268:	ff 75 f4             	pushl  -0xc(%ebp)
     26b:	e8 8b 0b 00 00       	call   dfb <close>
    wait(0);
     270:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
     277:	e8 5f 0b 00 00       	call   ddb <wait>
    wait(0);
     27c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
     283:	e8 53 0b 00 00       	call   ddb <wait>
    break;
     288:	83 c4 10             	add    $0x10,%esp
     28b:	e9 55 ff ff ff       	jmp    1e5 <runcmd+0x45>
  pid = fork();
     290:	e8 36 0b 00 00       	call   dcb <fork>
  if(pid == -1)
     295:	83 f8 ff             	cmp    $0xffffffff,%eax
     298:	0f 84 d3 00 00 00    	je     371 <runcmd+0x1d1>
    if(fork1() == 0)
     29e:	85 c0                	test   %eax,%eax
     2a0:	74 32                	je     2d4 <runcmd+0x134>
    wait(0);
     2a2:	83 ec 0c             	sub    $0xc,%esp
     2a5:	6a 00                	push   $0x0
     2a7:	e8 2f 0b 00 00       	call   ddb <wait>
    runcmd(lcmd->right);
     2ac:	59                   	pop    %ecx
     2ad:	ff 73 08             	pushl  0x8(%ebx)
     2b0:	e8 eb fe ff ff       	call   1a0 <runcmd>
    close(rcmd->fd);
     2b5:	83 ec 0c             	sub    $0xc,%esp
     2b8:	ff 73 14             	pushl  0x14(%ebx)
     2bb:	e8 3b 0b 00 00       	call   dfb <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     2c0:	58                   	pop    %eax
     2c1:	5a                   	pop    %edx
     2c2:	ff 73 10             	pushl  0x10(%ebx)
     2c5:	ff 73 08             	pushl  0x8(%ebx)
     2c8:	e8 46 0b 00 00       	call   e13 <open>
     2cd:	83 c4 10             	add    $0x10,%esp
     2d0:	85 c0                	test   %eax,%eax
     2d2:	78 18                	js     2ec <runcmd+0x14c>
      runcmd(bcmd->cmd);
     2d4:	83 ec 0c             	sub    $0xc,%esp
     2d7:	ff 73 04             	pushl  0x4(%ebx)
     2da:	e8 c1 fe ff ff       	call   1a0 <runcmd>
    panic("runcmd");
     2df:	83 ec 0c             	sub    $0xc,%esp
     2e2:	68 bb 12 00 00       	push   $0x12bb
     2e7:	e8 84 fe ff ff       	call   170 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     2ec:	50                   	push   %eax
     2ed:	ff 73 08             	pushl  0x8(%ebx)
     2f0:	68 d2 12 00 00       	push   $0x12d2
     2f5:	6a 02                	push   $0x2
     2f7:	e8 54 0c 00 00       	call   f50 <printf>
      exit(-1);
     2fc:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
     303:	e8 cb 0a 00 00       	call   dd3 <exit>
      panic("pipe");
     308:	83 ec 0c             	sub    $0xc,%esp
     30b:	68 e7 12 00 00       	push   $0x12e7
     310:	e8 5b fe ff ff       	call   170 <panic>
      close(1);
     315:	83 ec 0c             	sub    $0xc,%esp
     318:	6a 01                	push   $0x1
     31a:	e8 dc 0a 00 00       	call   dfb <close>
      dup(p[1]);
     31f:	58                   	pop    %eax
     320:	ff 75 f4             	pushl  -0xc(%ebp)
     323:	e8 23 0b 00 00       	call   e4b <dup>
      close(p[0]);
     328:	58                   	pop    %eax
     329:	ff 75 f0             	pushl  -0x10(%ebp)
     32c:	e8 ca 0a 00 00       	call   dfb <close>
      close(p[1]);
     331:	58                   	pop    %eax
     332:	ff 75 f4             	pushl  -0xc(%ebp)
     335:	e8 c1 0a 00 00       	call   dfb <close>
      runcmd(pcmd->left);
     33a:	5a                   	pop    %edx
     33b:	ff 73 04             	pushl  0x4(%ebx)
     33e:	e8 5d fe ff ff       	call   1a0 <runcmd>
      close(0);
     343:	83 ec 0c             	sub    $0xc,%esp
     346:	6a 00                	push   $0x0
     348:	e8 ae 0a 00 00       	call   dfb <close>
      dup(p[0]);
     34d:	5a                   	pop    %edx
     34e:	ff 75 f0             	pushl  -0x10(%ebp)
     351:	e8 f5 0a 00 00       	call   e4b <dup>
      close(p[0]);
     356:	59                   	pop    %ecx
     357:	ff 75 f0             	pushl  -0x10(%ebp)
     35a:	e8 9c 0a 00 00       	call   dfb <close>
      close(p[1]);
     35f:	58                   	pop    %eax
     360:	ff 75 f4             	pushl  -0xc(%ebp)
     363:	e8 93 0a 00 00       	call   dfb <close>
      runcmd(pcmd->right);
     368:	58                   	pop    %eax
     369:	ff 73 08             	pushl  0x8(%ebx)
     36c:	e8 2f fe ff ff       	call   1a0 <runcmd>
    panic("fork");
     371:	83 ec 0c             	sub    $0xc,%esp
     374:	68 e2 12 00 00       	push   $0x12e2
     379:	e8 f2 fd ff ff       	call   170 <panic>
...
strcpy(char *s, const char *t)
{
  ...
  os = s;
  while((*s++ = *t++) != 0)
     b7e:	89 d8                	mov    %ebx,%eax
     b80:	0f b6 0a             	movzbl (%edx),%ecx
     b83:	83 c2 01             	add    $0x1,%edx
     b86:	83 c0 01             	add    $0x1,%eax
     b89:	88 48 ff             	mov    %cl,-0x1(%eax)
     b8c:	84 c9                	test   %cl,%cl
     b8e:	75 f0                	jne    b80 <strcpy+0x10>
    ;
  s++;
  *s=0;
     b90:	c6 40 01 00          	movb   $0x0,0x1(%eax)
  return os;
}
...
00000e8b <getprocesstimedetails>:
