...
{ 
  ...
  10:	55                   	push   %ebp
   pid=0;
  11:	c7 05 00 0b 00 00 00 	movl   $0x0,0xb00
  18:	00 00 00 
{ 
  ...
  p=argv[1];
  22:	8b 48 04             	mov    0x4(%eax),%ecx
  while(*p){
  25:	0f be 01             	movsbl (%ecx),%eax
  28:	84 c0                	test   %al,%al
  ...
  while(*p){
  3a:	0f be 01             	movsbl (%ecx),%eax
  3d:	84 c0                	test   %al,%al
  3f:	75 ef                	jne    30 <main+0x30>
  41:	89 15 00 0b 00 00    	mov    %edx,0xb00

  a=numOpenFiles(pid);
  47:	83 ec 0c             	sub    $0xc,%esp
  4a:	52                   	push   %edx
  4b:	e8 7b 03 00 00       	call   3cb <numOpenFiles>
  if(a==-1)exit(-1);
  ...
  6a:	58                   	pop    %eax
  6b:	ff 35 00 0b 00 00    	pushl  0xb00
  71:	e8 5d 03 00 00       	call   3d3 <memAlloc>
  ...
  86:	5a                   	pop    %edx
  87:	ff 35 00 0b 00 00    	pushl  0xb00
  8d:	e8 49 03 00 00       	call   3db <getprocesstimedetails>
  exit(0);
  92:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  99:	e8 85 02 00 00       	call   323 <exit>
  }
...
strcpy(char *s, const char *t)
{
  ...
  os = s;
  while((*s++ = *t++) != 0)
  ce:	89 d8                	mov    %ebx,%eax
  d0:	0f b6 0a             	movzbl (%edx),%ecx
  d3:	83 c2 01             	add    $0x1,%edx
  d6:	83 c0 01             	add    $0x1,%eax
  d9:	88 48 ff             	mov    %cl,-0x1(%eax)
  dc:	84 c9                	test   %cl,%cl
  de:	75 f0                	jne    d0 <strcpy+0x10>
    ;
  s++;
  *s=0;
  e0:	c6 40 01 00          	movb   $0x0,0x1(%eax)
  return os;
}
...
000003db <getprocesstimedetails>:
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	eb 1a                	jmp    640 <printf+0x1a0>
          s = "(null)";
 626:	bb 3a 08 00 00       	mov    $0x83a,%ebx
        while(*s != 0){
