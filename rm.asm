...
main(int argc, char *argv[])
{
  ...
  4e:	6a 00                	push   $0x0
  50:	e8 9e 02 00 00       	call   2f3 <exit>
      printf(2, "rm: %s failed to delete\n", argv[i]);
  55:	50                   	push   %eax
  56:	ff 33                	pushl  (%ebx)
  58:	68 ec 07 00 00       	push   $0x7ec
  5d:	6a 02                	push   $0x2
  ...
  72:	e8 f9 03 00 00       	call   470 <printf>
    exit(-1);
  77:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
...
strcpy(char *s, const char *t)
{
  ...
  a0:	0f b6 0a             	movzbl (%edx),%ecx
  a3:	83 c2 01             	add    $0x1,%edx
  a6:	83 c0 01             	add    $0x1,%eax
  a9:	88 48 ff             	mov    %cl,-0x1(%eax)
  ac:	84 c9                	test   %cl,%cl
  ae:	75 f0                	jne    a0 <strcpy+0x10>
    ;
  s++;
  *s=0;
  b0:	c6 40 01 00          	movb   $0x0,0x1(%eax)
  return os;
}
...
000003ab <getprocesstimedetails>:
