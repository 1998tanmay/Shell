...
main(void)
{
  ...
  27:	0f 88 b1 00 00 00    	js     de <main+0xde>
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  dup(0);  // stdout
  ...
  6b:	78 2c                	js     99 <main+0x99>
      printf(1, "init: fork failed\n");
      exit(-1);
    }
    if(pid == 0){
  6d:	74 44                	je     b3 <main+0xb3>
  6f:	90                   	nop
      exec("sh", argv);
  ...
  73:	6a 00                	push   $0x0
  75:	e8 01 03 00 00       	call   37b <wait>
  ...
  ae:	e8 c0 02 00 00       	call   373 <exit>
      exec("sh", argv);
  b3:	50                   	push   %eax
  b4:	50                   	push   %eax
  b5:	68 5c 0b 00 00       	push   $0xb5c
  ba:	68 86 08 00 00       	push   $0x886
  bf:	e8 e7 02 00 00       	call   3ab <exec>
      printf(1, "init: exec sh failed\n");
  c4:	5a                   	pop    %edx
  c5:	59                   	pop    %ecx
  c6:	68 89 08 00 00       	push   $0x889
  cb:	6a 01                	push   $0x1
  cd:	e8 1e 04 00 00       	call   4f0 <printf>
      exit(0);
  d2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  d9:	e8 95 02 00 00       	call   373 <exit>
    mknod("console", 1, 1);
  de:	50                   	push   %eax
  df:	6a 01                	push   $0x1
  e1:	6a 01                	push   $0x1
  e3:	68 58 08 00 00       	push   $0x858
  e8:	e8 ce 02 00 00       	call   3bb <mknod>
    open("console", O_RDWR);
  ed:	58                   	pop    %eax
  ee:	5a                   	pop    %edx
  ef:	6a 02                	push   $0x2
  f1:	68 58 08 00 00       	push   $0x858
  f6:	e8 b8 02 00 00       	call   3b3 <open>
  fb:	83 c4 10             	add    $0x10,%esp
  fe:	e9 2a ff ff ff       	jmp    2d <main+0x2d>
...
strcpy(char *s, const char *t)
{
 ...
 120:	0f b6 0a             	movzbl (%edx),%ecx
 123:	83 c2 01             	add    $0x1,%edx
 126:	83 c0 01             	add    $0x1,%eax
 129:	88 48 ff             	mov    %cl,-0x1(%eax)
 12c:	84 c9                	test   %cl,%cl
 12e:	75 f0                	jne    120 <strcpy+0x10>
    ;
  s++;
  *s=0;
 130:	c6 40 01 00          	movb   $0x0,0x1(%eax)
  return os;
}
...
0000042b <getprocesstimedetails>:
