   ...
   e:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  30:	e8 9e 02 00 00       	call   2d3 <exit>
  }
  ...
  3d:	e8 f1 02 00 00       	call   333 <link>
  42:	83 c4 10             	add    $0x10,%esp
  45:	85 c0                	test   %eax,%eax
  47:	78 0a                	js     53 <main+0x53>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit(0);
  49:	83 ec 0c             	sub    $0xc,%esp
  4c:	6a 00                	push   $0x0
  4e:	e8 80 02 00 00       	call   2d3 <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  53:	ff 73 08             	pushl  0x8(%ebx)
  56:	ff 73 04             	pushl  0x4(%ebx)
  59:	68 cb 07 00 00       	push   $0x7cb
  5e:	6a 02                	push   $0x2
  60:	e8 eb 03 00 00       	call   450 <printf>
  65:	83 c4 10             	add    $0x10,%esp
  68:	eb df                	jmp    49 <main+0x49>
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
