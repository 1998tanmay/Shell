...
int main()
{
  ...
  psinfo();
  15:	e8 39 03 00 00       	call   353 <psinfo>
  exit(0);
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 00                	push   $0x0
  1f:	e8 6f 02 00 00       	call   293 <exit>
  24:	66 90                	xchg   %ax,%ax
  26:	66 90                	xchg   %ax,%ax
  28:	66 90                	xchg   %ax,%ax
  2a:	66 90                	xchg   %ax,%ax
...
strcpy(char *s, const char *t)
{
  ...
  40:	0f b6 0a             	movzbl (%edx),%ecx
  43:	83 c2 01             	add    $0x1,%edx
  46:	83 c0 01             	add    $0x1,%eax
  49:	88 48 ff             	mov    %cl,-0x1(%eax)
  4c:	84 c9                	test   %cl,%cl
  4e:	75 f0                	jne    40 <strcpy+0x10>
    ;
  s++;
  *s=0;
  50:	c6 40 01 00          	movb   $0x0,0x1(%eax)
  return os;
}
...
0000034b <getprocesstimedetails>:
