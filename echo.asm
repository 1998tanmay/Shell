...
strcpy(char *s, const char *t)
{
  ...
  90:	0f b6 0a             	movzbl (%edx),%ecx
  93:	83 c2 01             	add    $0x1,%edx
  96:	83 c0 01             	add    $0x1,%eax
  99:	88 48 ff             	mov    %cl,-0x1(%eax)
  9c:	84 c9                	test   %cl,%cl
  9e:	75 f0                	jne    90 <strcpy+0x10>
    ;
  s++;
  *s=0;
  a0:	c6 40 01 00          	movb   $0x0,0x1(%eax)
  return os;
}
...
0000039b <getprocesstimedetails>:
