...
{   int in=1;
  ...
  16:	c7 45 f0 08 08 00 00 	movl   $0x808,-0x10(%ebp)
  1d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
if (fork() == 0)
  24:	e8 f2 02 00 00       	call   31b <fork>
  29:	85 c0                	test   %eax,%eax
  2b:	74 16                	je     43 <main+0x43>
...
wait(0);
  ...
  30:	6a 00                	push   $0x0
  32:	e8 f4 02 00 00       	call   32b <wait>
  ...
  44:	50                   	push   %eax
  45:	6a 00                	push   $0x0
  47:	68 12 08 00 00       	push   $0x812
  4c:	e8 12 03 00 00       	call   363 <open>
        close(0);
  51:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
        int fd0 = open("/input.txt", O_RDONLY);
  58:	89 c3                	mov    %eax,%ebx
        close(0);
  5a:	e8 ec 02 00 00       	call   34b <close>
        dup(fd0);
  5f:	89 1c 24             	mov    %ebx,(%esp)
  62:	e8 34 03 00 00       	call   39b <dup>
        close(fd0);
  67:	89 1c 24             	mov    %ebx,(%esp)
  6a:	e8 dc 02 00 00       	call   34b <close>
        int fd1 = open("/home/tanmay/xv6-public/output", O_WRONLY) ;
  6f:	5a                   	pop    %edx
  70:	59                   	pop    %ecx
  71:	6a 01                	push   $0x1
  73:	68 20 08 00 00       	push   $0x820
  78:	e8 e6 02 00 00       	call   363 <open>
        close(1);
  7d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
        int fd1 = open("/home/tanmay/xv6-public/output", O_WRONLY) ;
  84:	89 c3                	mov    %eax,%ebx
        close(1);
  86:	e8 c0 02 00 00       	call   34b <close>
        dup(fd1);
  8b:	89 1c 24             	mov    %ebx,(%esp)
  8e:	e8 08 03 00 00       	call   39b <dup>
        close(fd1);
  93:	89 1c 24             	mov    %ebx,(%esp)
  96:	e8 b0 02 00 00       	call   34b <close>
    exec(cmd[0],cmd);   // Or your preferred alternative
  9b:	5b                   	pop    %ebx
  9c:	58                   	pop    %eax
  ...
  a4:	e8 b2 02 00 00       	call   35b <exec>
    exit(0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	eb 1a                	jmp    640 <printf+0x1a0>
          s = "(null)";
 626:	bb 3f 08 00 00       	mov    $0x83f,%ebx
        while(*s != 0){
